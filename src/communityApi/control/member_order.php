...
class member_orderControl extends mobileMemberControl
{
    ...
    public function order_listOp()
    {
        ...
        $field = "order_id,tuan_id,order_type,order_sn,pay_sn,store_id,store_name,goods_amount,order_amount,rcb_amount,pd_amount,shipping_fee,add_time,
    ...
    public function order_infoOp()
    {
        ...
        $field = "order_id,order_sn,pay_sn,store_id,store_name,goods_amount,order_amount,rcb_amount,pd_amount,shipping_fee,add_time,
            payment_code,payment_time,shipping_code,finnshed_time,order_state,lock_state,evaluation_state,chain_code,order_type,tuan_id";
