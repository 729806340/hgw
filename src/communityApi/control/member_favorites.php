...
class member_favoritesControl extends mobileMemberControl {
    ...
    public function favorites_delOp() {
        ...
        //$_POST= array('goods_id_list'=>'[100213,100278]');
        $fav_id_list = html_entity_decode($_POST['goods_id_list']);
        $fav_id_list = json_decode($fav_id_list );
        if (!is_array($fav_id_list)){
            output_error('参数错误');
        }
