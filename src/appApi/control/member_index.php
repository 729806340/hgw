...
class member_indexControl extends mobileMemberControl {
    ...
    public function indexOp() {
        ...
        $member_infos['avator'] = getMemberAvatarForID($this->member_info['member_id']);
        $member_infos['point'] = $this->member_info['member_points'];
        $member_infos['sex'] = $this->member_info['member_sex'];
        $member_infos['predepoit'] = $this->member_info['available_predeposit'];
        $member_infos['available_rc_balance'] = $this->member_info['available_rc_balance'];
