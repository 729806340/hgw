...
//				c.find("li").eq(f).css("z-index", "900").fadeOut(500, function() {
...
$(function() {
	...
	$("#nav_box li").each(function(a) {
		$(this).click(function() {
			$("html,body").animate({
				scrollTop: $(".home-standard-layout").eq(a).offset().top - 50 + "px"
			}, 500)
		}).mouseover(function() {
...
$(function(){
		var sliderNun = $(".pagination span");
       
        sliderNun.each(function(){
            
            var sliderSize = sliderNun.children().size();
