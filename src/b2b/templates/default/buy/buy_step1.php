...
<style>
    #fwin_goods_address_add .receive_add{padding: 5px 0 5px 15px;}
    #fwin_goods_address_add .hr16{text-align: center;}
    #fwin_goods_address_add span.true-name,.address strong {font-weight: 700; padding-right: 5px;}
    .goods-num {line-height:28px;}
</style>
