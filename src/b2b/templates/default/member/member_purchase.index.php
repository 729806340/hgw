...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a href="javascript:void(0)" class="ncbtn ncbtn-bittersweet" nc_type="dialog" dialog_title="<?php echo $lang['member_address_new_address'];?>" dialog_id="my_address_edit"  uri="index.php?act=member_purchase&op=address&type=add" dialog_width="550" title="<?php echo $lang['member_address_new_address'];?>"><i class="icon-map-marker"></i><?php echo '新增收货地址';?></a>
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="ncm-table-handle"><span>
          ...
          <a href="javascript:void(0);" class="btn-bluejeans" dialog_id="daisou" dialog_width="900" dialog_title="<?php echo $lang['member_address_edit_address'];?>" nc_type="dialog" uri="<?php echo B2B_SITE_URL;?>/index.php?act=member_purchase&op=delivery_add&id=<?php echo $address['address_id'];?>"><i class="icon-edit"></i>
          <p><?php echo $lang['nc_edit'];?></p>
          </a>
          <?php } else { ?>
          <a href="javascript:void(0);" class="btn-bluejeans" dialog_id="my_address_edit" dialog_width="550" dialog_title="<?php echo $lang['member_address_edit_address'];?>" nc_type="dialog" uri="<?php echo B2B_SITE_URL;?>/index.php?act=member_purchase&op=address&type=edit&id=<?php echo $address['address_id'];?>"><i class="icon-edit"></i>
          <p><?php echo $lang['nc_edit'];?></p>
          </a>
          <?php } ?>
          </span> <span><a href="javascript:void(0)" class="btn-grapefruit" onclick="ajax_get_confirm('<?php echo $lang['nc_ensure_del'];?>', '<?php echo B2B_SITE_URL;?>/index.php?act=member_purchase&op=address&id=<?php echo $address['address_id'];?>');"><i class="icon-trash"></i>
