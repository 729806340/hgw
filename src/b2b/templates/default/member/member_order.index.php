    ...
    <tbody<?php if (!empty($group_info['pay_amount']) && $p == 0) {?> class="pay" <?php }?>>
      ...
      <tr>
        <th colspan="19"> <span class="ml10"> 
          ...
          <?php }?>
            ...
            <a href="javascript:void(0)" class="share-goods" style="display: none;" nc_type="sharegoods" data-param='{"gid":"<?php echo $order_info['goods_list'][0]['goods_id'];?>"}'><i class="icon-share"></i><?php echo $lang['member_order_snsshare'];?></a>
          ...
          <?php if (false&&$order_info['if_delete']) { ?>
      ...
      <tr>
        ...
        <td class="tl"><dl class="goods-name">
            <dt><a href="<?php echo $goods_info['goods_url'];?>" target="_blank"><?php echo $goods_info['goods_name']; ?></a><span class="rec"><a style="display: none;" target="_blank" href="<?php echo urlShop('snapshot', 'index', array('rec_id' => $goods_info['rec_id']));?>">[交易快照]</a></span></dt>
