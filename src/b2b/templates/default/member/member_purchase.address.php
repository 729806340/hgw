...
<div class="eject_con">
  <div class="adds">
    <div id="warning"></div>
    <form method="post" action="<?php echo B2B_SITE_URL;?>/index.php?act=member_purchase&op=address" id="address_form" target="_parent">
      ...
      <dl>
        <dt><i class="required">*</i><?php echo '收货人'.$lang['nc_colon'];?></dt>
        <dd>
      ...
      <dl>
        <dt><i class="required">*</i><?php echo '所在地区'.$lang['nc_colon'];?></dt>
        <dd><input type="hidden" name="region" id="region" value="<?php echo $output['address_info']['area_info'];?>">
        </dd>
      </dl>
      <dl>
        <dt><i class="required">*</i><?php echo '街道地址'.$lang['nc_colon'];?></dt>
        <dd>
      ...
      <dl>
        <dt><i class="required">*</i><?php echo '电话号码'.$lang['nc_colon'];?></dt>
        <dd>
...
<!--          <p class="hint">--><?php //echo $lang['member_address_area_num'];?><!-- - --><?php //echo $lang['member_address_phone_num'];?><!-- - --><?php //echo $lang['member_address_sub_phone'];?><!--</p>-->
      ...
      <dl>
        <dt><i class="required">*</i><?php echo '手机号码'.$lang['nc_colon'];?></dt>
        <dd>
      ...
      <div class="bottom">
        <label class="submit-border">
          <input type="submit" class="submit" value="<?php if($output['type'] == 'add'){?><?php echo '新增收货地址';?><?php }else{?><?php echo '编辑收货地址';?><?php }?>" />
        </label>
