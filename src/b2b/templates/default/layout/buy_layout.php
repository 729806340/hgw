...
<style type="text/css">
body {
_behavior: url(<?php echo B2B_TEMPLATES_URL;
?>/css/csshover.htc);
}
...
<link href="<?php echo B2B_TEMPLATES_URL;?>/css/home_cart.css" rel="stylesheet" type="text/css">
...
<![endif]-->
<script>
var COOKIE_PRE = '<?php echo COOKIE_PRE;?>';var _CHARSET = '<?php echo strtolower(CHARSET);?>';var SITEURL = '<?php echo B2B_SITE_URL;?>';var MEMBER_SITE_URL = '<?php echo MEMBER_SITE_URL;?>';var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL;?>';var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL;?>';var B2B_TEMPLATES_URL = '<?php echo B2B_TEMPLATES_URL;?>';var PRICE_FORMAT = '<?php echo $lang['currency'];?>%s';
...
<script src="<?php echo B2B_RESOURCE_SITE_URL;?>/js/goods_cart.js"></script>
<?php } else { ?>
<script src="<?php echo B2B_RESOURCE_SITE_URL;?>/js/buy_virtual.js"></script>
<?php } ?>
...
<?php require_once template('layout/layout_top');?>  <header class="ncc-head-layout">
    <div class="site-logo"><a href="<?php echo B2B_SITE_URL;?>"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$output['setting_config']['site_logo']; ?>" class="pngFix"></a></div>
