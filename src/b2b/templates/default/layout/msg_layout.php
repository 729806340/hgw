...
<script>var COOKIE_PRE = '<?php echo COOKIE_PRE;?>';var _CHARSET = '<?php echo strtolower(CHARSET);?>';var SITEURL = '<?php echo B2B_SITE_URL;?>';var MEMBER_SITE_URL = '<?php echo MEMBER_SITE_URL;?>';var B2B_RESOURCE_SITE_URL = '<?php echo B2B_RESOURCE_SITE_URL;?>';var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL;?>';var B2B_TEMPLATES_URL = '<?php echo B2B_TEMPLATES_URL;?>';</script>
...
<div class="header-wrap"><header class="public-head-layout wrapper">
  <h1 class="site-logo"><a href="<?php echo B2B_SITE_URL;?>"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$output['setting_config']['site_logo']; ?>" class="pngFix"></a></h1></header></div>
<div class="msg">
