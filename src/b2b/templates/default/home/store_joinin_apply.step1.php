  ...
  <form id="form_company_info" action="index.php?act=store_joinin&op=step2" method="post">
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        ...
        <tr>
          <th><i>*</i>员工总数：</th>
          <td><input name="company_employee_count" type="text" class="w50" value="<?php echo $output['joinin_detail']['company_employee_count']; ?>"/>
            &nbsp;人 <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>注册资金：</th>
        ...
        <tr>
          <th><i>*</i>联系人电话：</th>
          <td><input name="contacts_phone" type="text" class="w100"  value="<?php echo $output['joinin_detail']['contacts_phone']; ?>" />
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>电子邮箱：</th>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        ...
        <tr>
          ...
          <?php if($output['joinin_detail']['business_licence_number_elc']) {?>
          <img src="<?php echo C('upload_site_url');?>/shop/store_joinin/<?php echo $output['joinin_detail']['business_licence_number_elc']; ?>" height="60">
          <?php }?>
            <span class="block">请确保图片清晰，文字可辨并有清晰的红色公章。</span>
            <input name="business_licence_number_elc1" type="hidden" value="<?php echo $output['joinin_detail']['business_licence_number_elc']; ?>"/><span></span>
            </td>
        </tr>
      </tbody>
      <tfoot>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        ...
        <tr>
          ...
          <?php if($output['joinin_detail']['organization_code_electronic']) {?>
          <img src="<?php echo C('upload_site_url');?>/shop/store_joinin/<?php echo $output['joinin_detail']['organization_code_electronic']; ?>" height="60">
          <?php }?>
            <span class="block">请确保图片清晰，文字可辨并有清晰的红色公章。</span>
            <input name="organization_code_electronic1" type="hidden" value="<?php echo $output['joinin_detail']['organization_code_electronic']; ?>"/><span></span>
            </td>
        </tr>
      </tbody>
      <tfoot>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        <tr>
          ...
          <img src="<?php echo C('upload_site_url');?>/shop/store_joinin/<?php echo $output['joinin_detail']['general_taxpayer']; ?>" height="60">
          <?php }?>
            <span class="block">请确保图片清晰，文字可辨并有清晰的红色公章。</span>
            <input name="general_taxpayer1" type="hidden" value="<?php echo $output['joinin_detail']['general_taxpayer']; ?>"/><span></span>
            </td>
        </tr>
      </tbody>
      <tfoot>
