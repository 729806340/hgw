...
<div id="apply_agreement" class="apply-agreement">
  ...
  <div class="bottom"><a style="display:none" id="btn_apply_agreecbc_next" href="javascript:;" class="btn">个人入驻</a><a id="btn_apply_agreement_next" href="javascript:;" class="btn">企业入驻</a></div>
</div>
