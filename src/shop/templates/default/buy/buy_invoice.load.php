      ...
      <div id="invoice_panel" class="ncc-form-default">
        <dl>
          ...
          <dd>
            ...
            <input class="text w200" style="display:none" name="inv_code" id="inv_code" placeholder="税号" value="">
          </dd>
        </dl>
        <dl>
...
$(function(){
    ...
    $('#hide_invoice_list').on('click',function(){
        ...
        if ($('input[name="invoice_type"]:checked').val() == 1){
            ...
            }else if($.trim($('#inv_code').val()) == '' || $.trim($('#inv_code').val()) == '税号'){
                showDialog('请填写税号', 'error','','','','','','','','',2);return false;
            }else{
