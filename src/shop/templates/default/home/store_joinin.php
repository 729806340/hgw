  ...
  <div class="user-box">
    ...
    <div class="user-joinin">
      ...
      <dl>
        ...
        <dd> 若您还没有填写入驻申请资料<br/>
          请点击“<a href="<?php echo urlShop('store_joinin', 'step');?>" target="_blank">我要入驻</a>”进行入驻资料填写</dd>
        <dd>若您的店铺还未开通<br/>
          请通过“<a href="<?php echo urlShop('store_joinin', 'index');?>" target="_blank">查看入驻进度</a>”了解店铺开通的最新状况 </dd>
      </dl>
      <div class="bottom"><a href="<?php echo urlShop('store_joinin', 'step');?>" target="_blank">我要入驻</a><a href="<?php echo urlShop('store_joinin', 'index');?>" target="_blank">查看入驻进度</a></div>
    </div>
     <?php }else { ?>
...
<div class="indextip">
  <div class="container"> <span class="title"><i></i>
    <h3>商家助手</h3>
    </span> <span class="content"><?php echo $output['show_txt'];?></span>
    <span class="titles"><a target="_blank" href="/?act=show_help&op=index"><i></i><h3>商家帮助</h3></a></span>
  </div>
</div>
<div class="mains">
