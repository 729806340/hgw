...
<div class="nch-breadcrumb-layout" style="display: block;">
  <div class="nch-breadcrumb wrapper"> <i class="icon-home"></i> <span> <a href="<?php echo urlShop(); ?>">首页</a> </span> <span class="arrow">></span> <span>VIP特惠</span></div>
</div>
  ...
  <div class="ncg-content">
    ...
    <div class="ncg-slides-banner">
      <ul id="fullScreenSlides" class="full-screen-slides">
        ...
        <li><a href="<?php echo $p[2];?>" target="_blank"><img src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_LIVE.'/'.$p[0];?>"></a></li>
        <?php } ?>
      </ul>
    </div>
    <?php } ?>
    ...
    <div class="group-list mt20">
      ...
      <ul>
        ...
        <li class="<?php echo $output['current'];?>">
          <div class="ncg-list-content clearfix"> 
			<div class="l-thumb">
				<a title="<?php echo $groupbuy['groupbuy_name'];?>" href="<?php echo $groupbuy['groupbuy_url'];?>" target="_blank"><img shopwwi-url="<?php echo gthumb($groupbuy['groupbuy_image'],'max');?>" rel='lazy' src="<?php echo SHOP_SITE_URL;?>/img/loading.gif" alt=""></a>
			</div>
            <div class="r-info">
      ...
      <?php } else { ?>
      <div class="norecommend">暂无今日推荐</div>
      <?php } ?>
    </div>
