...
<div class="main">
  <div class="sidebar">
    ...
    <div class="content">
      ...
      <?php
        foreach($output['list'] as $key => $val){ ?>
      ...
      <?php } ?>
      <dl>
        <dt class="<?php echo $output['sub_step'] == 'step-1' ? 'current' : '';?>"> <i class="hide"></i>选择商家类型</dt>
      </dl>
      <dl show_id="0">
        ...
        <dl>
        <dt class="<?php echo $output['step'] == '5' ? 'current' : '';?>"> <i class="hide"></i>合同签订及缴费</dt>
      </dl>
      <dl>
  ...
  <div class="right-layout">
    <div class="joinin-step">
      <ul>
        <li class="step1 <?php echo $output['step'] >= -1 ? 'current' : '';?>"><span>选择商家类型</span></li>
        ...
        <li class="<?php echo $output['step'] >= 3 ? 'current' : '';?>"><span>店铺经营信息</span></li>
          <li class="<?php echo $output['step'] >= 4 ? 'current' : '';?>"><span>签订入驻协议</span></li>
          <li class="<?php echo $output['step'] >= 5 ? 'current' : '';?>"><span>合同签订及缴费</span></li>
