    ...
    <div class="group-list">
      <ul>
        ...
        <li class="<?php echo $output['current']; ?>">
          <div class="ncg-list-content"> <a title="<?php echo $groupbuy['groupbuy_name'];?>" href="<?php echo $groupbuy['groupbuy_url'];?>" class="pic-thumb" target="_blank"><img shopwwi-url="<?php echo gthumb($groupbuy['groupbuy_image'],'max');?>" rel='lazy' src="<?php echo SHOP_SITE_URL;?>/img/loading.gif" alt=""></a>
