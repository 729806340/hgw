...
<div>
    ...
    {
        header("Location:/wap/tmpl/product_detail.html?goods_id=".$output['goods']['goods_id']);
    }
    ?>
</div>
<div class="wrapper pr">
  ...
  <div class="ncs-detail<?php if ($output['store_info']['is_own_shop']) echo ' ownshop'; ?>"> 
   <!-- 焦点图 -->
    ...
    <!-- S 商品基本信息 -->
      <div id="goods-summary" style="display: none;" class="ncs-goods-summary">
          <div class="name">
              <h1><?php echo $output['goods']['goods_name']; ?></h1>
              <strong><?php echo str_replace("\n", "<br>", $output['goods']['goods_jingle']); ?></strong></div>
          <div id="xianshi-notice" class="ncs-xianshi" ctrl="goods.promotion_type=='xianshi'" style="">
              <img src="/shop/resource/img/mszqxq.png" style="margin: 8px;">
              <p style="">距离结束还剩 <em id="xiansh-hour">05</em> : <em id="xiansh-minute">21</em> : <em id="xiansh-second">33</em></p>
          </div>
          <div class="ncs-meta" style="width: 589px;">
              <!-- S 商品参考价格 -->
              <dl id="market-price" ctrl="goods.is_book==0">
                  <dt><?php echo $lang['goods_index_goods_cost_price']; ?><?php echo $lang['nc_colon']; ?></dt>
                  <dd class="cost-price">
                      <strong><?php echo $lang['currency']; ?>
                          <span model="goods_marketprice"></span>
                      </strong>
                  </dd>
              </dl>
              <dl id="book-market-price"  ctrl="goods.is_book==1">
                  <dt><?php echo $lang['goods_index_goods_price']; ?><?php echo $lang['nc_colon']; ?></dt>
                  <dd class="cost-price">
                      <strong><?php echo $lang['currency']; ?><span model="goods_price"></span></strong></dd>
              </dl>

              <!-- E 商品参考价格 -->
              <!-- S 商品发布价格 -->
              <dl id="mall-price" ctrl="goods.is_book==0 && !goods.is_pintuan">
                  <dt><?php echo $lang['goods_index_goods_price']; ?><?php echo $lang['nc_colon']; ?></dt>
                  <dd class="price" id="goods-price">
                      <div  ctrl="goods.promotion_price>0">
                          <strong><i><?php echo $lang['currency']; ?></i>
                              <span model="promotion_price"></span>
                          </strong>
                          <em>(原售价<?php echo $lang['nc_colon']; ?><?php echo $lang['currency']; ?>
                              <span model="goods_price"></span>
                              )</em>
                      </div>
                          <strong ctrl="goods.promotion_price==undefined||goods.promotion_price<=0"><?php echo $lang['currency']; ?>
                              <span model="goods_price"></span>
                          </strong>
                  </dd>
              </dl>
              <dl id="pintuan-price" ctrl="goods.is_pintuan">
                  <dt>拼&nbsp;&nbsp;团&nbsp;&nbsp;价<?php echo $lang['nc_colon']; ?></dt>
                  <dd class="price" id="goods-price">
                          <strong ><?php echo $lang['currency']; ?>
                              <span model="goods.promotion_price"></span>
                          </strong>
                      <em>(正常购买<?php echo $lang['nc_colon']; ?><?php echo $lang['currency']; ?>
                          <span model="goods_price"></span>
                          )</em>
                  </dd>
              </dl>
              <dl id="pintuan-description" ctrl="goods.is_pintuan">
                  <dt></dt>
                  <dd class="description">
                      <span ctrl="goods.is_pintuan" model="goods.pintuan_limit_user"></span>人成团，最低限购<span ctrl="goods.is_pintuan" model="goods.pintuan_limit_floor"></span>件
                  </dd>
              </dl>
              <dl class="rate" ctrl="goods.is_book==0">
                  <dt>商品评分：</dt>
                  <!-- S 描述相符评分 -->
                  <dd><span class="raty"
                            data-score="<?php echo $output['goods_evaluate_info']['star_average']; ?>"></span><a
                          href="#ncGoodsRate">共有<?php echo $output['goods']['evaluation_count']; ?>条评价</a></dd>
                  <!-- E 描述相符评分 -->
              </dl>
              ...
              <!-- E 商品发布价格 -->
              <!-- S 预定商品 -->
              <dl id="book-price" ctrl="goods.is_book==1">
                  <dt>预定价格<?php echo $lang['nc_colon']; ?></dt>
                  <dd class="price">
                      <strong><?php echo $lang['currency']; ?><span model="(goods.book_down_payment-1+(goods.book_final_payment-1)+2).toFixed(2)"></span></strong>
                  </dd>
              </dl>
          </div>
          <div class="ncs-book-down" ctrl="goods.is_book==1">
              <div class="rule-price">
                  <strong>定金</strong><?php echo $lang['currency']; ?>
                  <span model="book_down_payment"></span>
              </div>
              <div class="rule-symbol">+</div>
              <div class="rule-price">
                  <strong>尾款</strong><?php echo $lang['currency']; ?>
                  <span model="book_final_payment"></span>
              </div>
              <div class="rule-info"><a mxf="sqde" href="javascript:void(0);">预定规则<i class="icon-question-sign"></i>
                      <ul>
                          ...
                          <li>4.尾款开始付款后，请在要求的时间（<?php echo BOOK_AUTO_END_TIME; ?>
                              小时）内支付尾款，若超时将自动关闭订单，且定金不予退还。请注意预售的结束时间，并及时支付尾款；
                          </li>
          ...
          <dl ctrl="goods.is_book==1">
              <dt>预定人数<?php echo $lang['nc_colon']; ?></dt>
              <dd><strong model="book_buyers"></strong> 人</dd>
          </dl>
          <dl ctrl="goods.is_book==1">
              <dt>预定结束<?php echo $lang['nc_colon']; ?></dt>
              <dd>
                  剩余<strong remain="day"><?php echo $output['remain']['day']; ?></strong>天<strong remain="hour"><?php echo $output['remain']['hour']; ?></strong>时<strong remain="minute"><?php echo $output['remain']['minute']; ?></strong>分<strong remain="second">0</strong>秒
              </dd>
          </dl>
          <!-- S 预定商品 -->
          <div ctrl="goods.goods_state!=10&&goods.goods_verify==1">
      <!-- S 促销 -->
              <div model="promotion_html"></div>
      <div class="ncs-sale" ctrl="false">
        <dl ctrl="goods.promotion_type||goods.jjg_explain||goods.promotion_info.mansong_info">
          <dt>促&#12288;&#12288;销：</dt>
          <dd class="promotion-info">
            <span class="sale-name" model="title" ctrl="goods.title"></span>
            <!-- S 限时折扣 -->
            <span class="sale-rule w400" ctrl="goods.promotion_type=='xianshi'">直降<em><?php echo $lang['currency'];?></em><em model="down_price"></em>
                <any model="lower_limit" ctrl="goods.lower_limit"></any>
                <any model="explain"></any>
            </span>
            <!-- E 限时折扣  -->
            <!-- S 特卖-->
                    <any ctrl="goods.promotion_type=='groupbuy'">
            <em ctrl="goods.upper_limit">
                最多限购<any model="upper_limit"></any>件
            </em>
            <span model="remark"><?php echo $output['goods']['remark'];?></span><br>
                </any>
            <!-- E 特卖 -->
            <!--S 满就送 -->
            <?php if($output['mansong_info']) { ?>
            <div class="ncs-mansong" ctrl="goods.promotion_info.mansong_info"> <span class="sale-name">满即送</span> <span class="sale-rule">
            ...
            <div class="ncs-jjg" ctrl="goods.jjg_explain"> <span class="sale-name">加价购</span> <span class="sale-rule"><?php echo $output['goods']['jjg_explain']; ?></span> <span nctype="show-rule" class="sale-rule-more"><a href="javascript:void(0);">共<strong><?php echo count($output['goods']['jjg_info']['levels']);?></strong>项，展开查看<i></i></a></span>
              <div class="sale-rule-content" style="display: none;" nctype="rule-content">
...
$shownLevelSkus[$sku] = true; ?>
        ...
        <hr ctrl="goods.have_gift=='gift'" />
        <dl ctrl="goods.have_gift=='gift'">
          <dt>赠&#12288;&#12288;品：</dt>
      ...
      <div class="ncs-logistics"><!-- S 物流与运费新布局展示 ByShopWWI汉购网 -->
      ...
      <div class="ncs-key"> 
        ...
        <!-- 预售商品发货时间 -->
        <dl  ctrl="goods.is_virtual!=1&&goods.is_presell==1">
          <dt>预&#12288;&#12288;售：</dt>
          <dd>
            <ul>
              <li class="sp-txt"><a href="javascript:void(0)" class="hovered">
                      <span model="goods.presell_deliverdate"></span>
                      日发货<i></i></a></li>
            </ul>
          </dd>
        </dl>
        <!-- 预售商品发货时间 -->
        <dl ctrl="goods.is_fcode>0">
          <dt>购买类型：</dt>
          <dd>
            <ul>
      ...
      <!-- S 购买数量及库存 -->
      <div class="ncs-buy">
        <div class="ncs-figure-input" ctrl="goods.goods_state!=0&&goods.goods_storage>0">
        ...
        <div class="ncs-point" ctrl="goods.goods_state!=0&&goods.goods_storage>0" style="display: none;"><i></i>
          <!-- S 库存 --> 
        ...
        <!-- S 提示已选规格及库存不足无法购买 -->
        <div  ctrl="goods.goods_state==0||goods.goods_storage<=0"  nctype="goods_prompt" class="ncs-point"><i></i> <span>您选择的商品<strong>库存不足</strong>；请选择店内其它商品或申请<a href="javascript:void(0);" nctype="arrival_notice" class="arrival" title="到货通知">到货通知</a>提示。</span> </div>
        <!-- E 提示已选规格及库存不足无法购买 -->
        <!-- S 购买按钮 -->
        <div class="ncs-btn cart01">
          <!-- 加入购物车-->
          <a ctrl="goods.cart==true&&(goods.goods_state==0||goods.goods_storage<=0||(goods.store_info.manage_type!='platform'&&(goods.goods_cost<=0||goods.tax_input>=100||goods.tax_output>=100)))" href="javascript:void(0);"  class="addcart no-addcart " title="<?php echo $lang['goods_index_add_to_cart'];?>"><i class="icon-shopping-cart"></i><?php echo $lang['goods_index_add_to_cart'];?></a>
          <a ctrl="goods.cart==true&&goods.goods_state!=0&&goods.goods_storage>0&&(goods.store_info.manage_type=='platform'||(goods.goods_cost>0&&goods.tax_input<100&&goods.tax_output<100))" href="javascript:void(0);" nctype="addcart_submit" class="addcart" title="<?php echo $lang['goods_index_add_to_cart'];?>"><i class="icon-shopping-cart"></i><?php echo $lang['goods_index_add_to_cart'];?></a>
          <!-- 立即购买-->
          <a ctrl="goods.buynow==true&&goods.goods_state!=0&&goods.goods_storage>0&&(goods.store_info.manage_type=='platform'||(goods.goods_cost>0&&goods.tax_input<100&&goods.tax_output<100))" href="javascript:void(0);" nctype="buynow_submit" class="buynow buynow_text <?php if ($output['goods']['goods_state'] == 0 || $output['goods']['goods_storage'] <= 0 || ($output['goods']['is_virtual'] == 1 && $output['goods']['virtual_indate'] < TIMESTAMP)) {?>no-buynow<?php }?>" title="<?php echo $output['goods']['buynow_text'];?>" model="buynow_text"></a>
          <!-- S 加入购物车弹出提示框 -->
          <div class="ncs-cart-popup">
            <dl>
              ...
              <dd><?php echo $lang['goods_index_cart_have'];?> <strong class="bold_num"></strong> <?php echo $lang['goods_index_number_of_goods'];?> <?php echo $lang['goods_index_total_price'];?><?php echo $lang['nc_colon'];?><em class="bold_mly" class="saleP"></em></dd>
      ...
      <div  ctrl="goods.goods_state==10||goods.goods_verify!=1" class="ncs-buy">
      ...
      <div id="goods-loading" class="ncs-goods-summary">
          <div class="name">
              <h1><?php echo $output['goods']['goods_name']; ?></h1>
              <strong><?php echo str_replace("\n", "<br>", $output['goods']['goods_jingle']); ?></strong></div>
          <div class="ncs-meta">
              ...
              <dl>
                  <dt><?php echo $lang['goods_index_goods_price']; ?><?php echo $lang['nc_colon']; ?></dt>
                  <dd class="price" id="goods-price"><strong>...</strong>
                  </dd>
              </dl>
              <dl class="rate">
                  <dt>商品评分：</dt>
      ...
      <div class="ncs-buy">
        ...
        <div class="ncs-btn">
          <!-- 加入购物车-->
          <a href="javascript:void(0);" class="addcart no-addcart " title="<?php echo $lang['goods_index_add_to_cart'];?>"><i class="icon-shopping-cart"></i><?php echo $lang['goods_index_add_to_cart'];?></a>
          <!-- 立即购买-->
          <a href="javascript:void(0);" class="buynow no-buynow" title="<?php echo $output['goods']['buynow_text'];?>" >立即购买</a>
        </div>
        <!-- E 购买按钮 -->
      </div>
      <!-- E 购买数量及库存 -->
    ...
    <div class="ncs-handle"> 
      ...
      <a class="when-user" href="index.php?act=member_inform&op=inform_submit&goods_id=<?php echo $output['goods']['goods_id'];?>" title="<?php echo $lang['goods_index_goods_inform'];?>" class="inform" id="inform"><i></i><?php echo $lang['goods_index_goods_inform'];?></a>
      <a class="when-guest"  href="javascript:login_dialog();"  title="<?php echo $lang['goods_index_goods_inform'];?>" class="inform" id="inform"><i></i><?php echo $lang['goods_index_goods_inform'];?></a>
      <?php } ?>
      <!-- End --> </div>
  ...
  <div class="ncs-goods-main" id="main-nav-holder">
    <div class="tabbar pngFix" id="main-nav">
      <div class="ncs-goods-title-nav">
        ...
        <div class="add-cart cart02">
            <a ctrl="goods.cart==true&&(goods.goods_state==0||goods.goods_storage<=0||(goods.store_info.manage_type!='platform'&&(goods.goods_cost<=0||goods.tax_input>=100||goods.tax_output>=100)))" href="javascript:void(0);"  class="addcart no-addcart " title="<?php echo $lang['goods_index_add_to_cart'];?>"><i class="icon-shopping-cart"></i><?php echo $lang['goods_index_add_to_cart'];?></a>
          <a ctrl="goods.cart==true&&goods.goods_state!=0&&goods.goods_storage>0&&(goods.store_info.manage_type=='platform'||(goods.goods_cost>0&&goods.tax_input<100&&goods.tax_output<100))" href="javascript:void(0);" nctype="addcart_submit" class="addcart" title="<?php echo $lang['goods_index_add_to_cart'];?>"><i class="icon-shopping-cart"></i><?php echo $lang['goods_index_add_to_cart'];?></a>
            <!-- S 加入购物车弹出提示框 -->
          <div class="ncs-cart-popup cart-popup02">
            <dl>
              <dt><?php echo $lang['goods_index_cart_success'];?><a title="<?php echo $lang['goods_index_close'];?>" onClick="$('.ncs-cart-popup').css({'display':'none'});">X</a></dt>
              <dd><?php echo $lang['goods_index_cart_have'];?> <strong class="bold_num"></strong> <?php echo $lang['goods_index_number_of_goods'];?> <?php echo $lang['goods_index_total_price'];?><?php echo $lang['nc_colon'];?><em class="bold_mly" class="saleP"></em></dd>
              <dd class="btns"><a href="javascript:void(0);" class="ncbtn-mini ncbtn-mint" onClick="location.href='<?php echo SHOP_SITE_URL.DS?>index.php?act=cart'"><?php echo $lang['goods_index_view_cart'];?></a> <a href="javascript:void(0);" class="ncbtn-mini" value="" onClick="$('.ncs-cart-popup').css({'display':'none'});"><?php echo $lang['goods_index_continue_shopping'];?></a></dd>
...
<form id="buynow_form" method="post" action="<?php echo SHOP_SITE_URL;?>/index.php">
  ...
  <input id="is_pintuan" name="is_pintuan" type="hidden" value=""/>
  <input id="tuan_id" name="tuan_id" type="hidden" value="<?php echo $_GET['tuan']?>"/>
</form>
...
if(!Hangowa.isLogged()){
    ...
    if(storeId =='<?php echo $output['goods']['store_id'];?>'){
...
$(function(){
  Hangowa.initialGoods(<?php echo $output['goods']['goods_id'];?>,function (goodsInfo) {
      if(goodsInfo.is_pintuan == 1){
          $('#is_pintuan').val(1);
          <?php if($_GET['tuan']){?>
            // 替换立即开团语句
          $('.buynow_text').text('立即参团');
          <?php } ?>
      }
...
//触及显示缩略图
    ...
    // 满即送、加价购显示隐藏
    $(document).on('click','[nctype="show-rule"]',function (e) {
        console.log(e);
        $(this).parent().find('[nctype="rule-content"]').show();
    }).on('click','[nctype="hide-rule"]',function (e) {
