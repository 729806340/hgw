        ...
        <ul>
          ...
          <li>
            <dl>
              ...
              <dd class="goods-info"><span class="price"><i><?php echo $lang['currency'];?></i> <?php echo ncPriceFormat($value['goods_promotion_price']>0?$value['goods_promotion_price']:$value['goods_price']);?> </span> <span class="goods-sold"><?php echo $lang['show_store_index_be_sold'];?><strong><?php echo $value['goods_salenum'];?></strong> <?php echo $lang['nc_jian'];?></span></dd>
