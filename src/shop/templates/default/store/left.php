...
<?php foreach ((array) $output['goods_rand_list'] as $g) { ?>
          <li>
            <dl>
              ...
              <dd class="goods-price"><?php echo $lang['currency'];?><?php echo ncPriceFormat($g['goods_promotion_price']>0?$g['goods_promotion_price']:$g['goods_price']); ?></dd>
            </dl>
          </li>
          <?php }?>
        </ul>
      ...
      <ol>
        ...
        <li>
          <dl>
            ...
            <dd class="price pngFix"><?php echo ncPriceFormat($val['goods_promotion_price']>0?$val['goods_promotion_price']:$val['goods_price']);?></dd>
