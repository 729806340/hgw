...
<div class="ncsc-flow-item">
  ...
  <div class="item-order">
      ...
      <dd><a target="_blank" href="index.php?act=store_order&op=show_order&order_id=<?php echo $output['order']['order_id']; ?>"><?php echo $output['order']['order_sn'];?></a> <a href="javascript:void(0);" class="a">更多<i class="icon-angle-down"></i>
        <div class="more"> <span class="arrow"></span>
          <ul>
            ...
            <?php } ?><?php if ($output['order']['import_time'] > 0) { ?>
            <li>导入时间：<span><?php echo date("Y-m-d H:i:s",$output['order']['import_time']); ?></span></li>
            <?php } ?>
    ...
    <dl class="line">
      ...
      <dl class="line">
          <dt><strong>订单状态：</strong></dt>
          <dd style="color:red"><strong><?php echo $output['order']['order_state'];?></strong></dd>
      </dl>
  </div>
</div>