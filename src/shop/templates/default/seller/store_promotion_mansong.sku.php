...
<a nctype="btn_add_mansong_goods" id="result-sku-<?php echo $val['goods_id'];?>" data-goods-id="<?php echo $val['goods_id'];?>" data-goods-name="<?php echo $val['goods_name'];?>" data-goods-image-url="<?php echo $goods_image_url;?>" data-goods-url="<?php echo $goods_url;?>" href="javascript:void(0);" class="ncbtn-mini ncbtn-mint"><i class="icon-circle "></i>选择为条件商品</a>
</li>
<?php } ?>
</ul>
