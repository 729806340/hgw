...
<script>
    $(function () {
        $("#importorder").click(function() {
            ...
            $.ajax({
                type: "POST",
                url: "index.php?act=fenxiao_order_refund&op=index&action=importrefund",
                data: formdata,
                dataType: "json",
                contentType: false,
                processData: false,
                ...
                success: function(data)
                {
                    if (data.status == '1') {
                        ...
                        if(answer) {
                            location.href="index.php?act=fenxiao_order_refund&op=export_refund_result&key_name=" + data.data.key_name;
                        }
                    } else {
                        alert(data.msg);
                    }
