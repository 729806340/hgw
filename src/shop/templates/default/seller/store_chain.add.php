...
<div class="ncsc-form-default">
  <form method="post" action="<?php echo empty($output['chain_info']) ? urlShop('store_chain', 'chain_add') : urlShop('store_chain', 'chain_edit', array('chain_id' => $output['chain_info']['chain_id']));?>" id="chain_form" enctype="multipart/form-data">
    ...
    <dl>
      ...
      <dl>
          <dt><i class="required">*</i>经度<?php echo $lang['nc_colon'];?></dt>
          <dd>
              <input type="text" class="textarea w200" name="longitude"  value="<?php echo $output['chain_info']['longitude'];?>" />
              <p class="hint">请认真填写门店的经度。</p>
          </dd>
      </dl>
      <dl>
          <dt><i class="required">*</i>纬度<?php echo $lang['nc_colon'];?></dt>
          <dd>
              <input type="text" class="textarea w200" name="latitude" value="<?php echo $output['chain_info']['latitude'];?>" />
              <p class="hint">请认真填写门店的维度。</p>
          </dd>
      </dl>
    <dl>
