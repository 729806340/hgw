...
<div class="wrap">
  ...
  <form name="deliver_form" method="POST" id="deliver_form" action="index.php?act=store_deliver&op=send&order_id=<?php echo $_GET['order_id'];?>" onsubmit="ajaxpost('deliver_form', '', '', 'onerror');return false;">
    ...
    <?php echo $lang['store_deliver_express_note'];?><br>
   	 如果一个订单分多个快递包裹发货，请在“快递编号”之间，用英文半角逗号 , 来分隔多个快递编号
    </div>
    <div class="tabmenu">
      <ul class="tab pngFix">
    ...
    <table class="ncsc-default-table order" id="texpress1">
      <tbody>
        ...
        <tr>
          ...
          <td class="bdl"><input name="shipping_code" type="text" class="text w200" title="" maxlength="200" nc_type='eb' nc_value="<?php echo $v;?>" /></td>
