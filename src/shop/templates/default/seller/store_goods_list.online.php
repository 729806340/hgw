...
<?php if($output['store_info']['manage_type']=="co_construct"){ ?>
<style>
    .nscs-table-handle span {  display: inherit;}
    .nscs-table-handle span a{  padding: 0px;  }
    .platform .update_goodscost {display: none;}
</style>
<?php } ?>
  ...
  <tbody class="<?php if($output['store_info']['manage_type']=="co_construct") {echo 'co_construct';}else{echo 'platform';}?>">
    ...
    <tr>
      ...
      <td class="nscs-table-handle" >
          <?php if(false&&$output['store_info']['manage_type']=="co_construct"){ ?>
          <span><a class="btn-bluejeans" href="javascript:void(0)"  nc_type="dialog" dialog_title="修改商品成本价" dialog_id="my_goods_cost_update"
                   dialog_width="600" uri="index.php?act=store_goods_online&op=update_goodscost&goods_id=<?php echo $output['storage_array'][$val['goods_commonid']]['goods_id'];?>">
                  <i class="icon-edit"></i><p>修改成本价</p></a>
          </span>
          <?php } ?>
        ...
        <p><?php echo $lang['nc_edit'];?></p></a></span>
  ...
  <tfoot>
    ...
    <tr>
      ...
      <th colspan="10"><label for="all2"><?php echo $lang['nc_select_all'];?></label>
        <a href="javascript:void(0);" nc_type="batchbutton"
           uri="<?php echo urlShop('store_goods_online', 'drop_goods');?>"
           name="commonid" confirm="<?php echo $lang['nc_ensure_del'];?>"
           class="ncbtn-mini"><i class="icon-trash"></i><?php echo $lang['nc_del'];?></a>
          <a href="javascript:void(0);" nc_type="batchbutton"
             uri="<?php echo urlShop('store_goods_online', 'goods_unshow');?>"
             name="commonid" class="ncbtn-mini"><i class="icon-level-down"></i><?php echo $lang['store_goods_index_unshow'];?></a>
          <a href="javascript:void(0);" class="ncbtn-mini" nctype="batch"
             data-param="{url:'<?php echo urlShop('store_goods_online', 'edit_jingle');?>', sign:'jingle'}"><i>
              </i>设置广告词</a>
