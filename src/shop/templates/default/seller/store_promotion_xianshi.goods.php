...
<div id="dialog_add_xianshi_goods" style="display:none;">
  ...
  <div class="eject_con">
    ...
    <dl>
      ...
      <dt>限时折扣库存：</dt>
      <dd>
        <input id="dialog_xianshi_storage" type="text" class="text w70">
        <em class="add-on">件</em>
        <p class="hint">限时折扣库存应低于正常商品库存，限时折扣库存卖完后系统将恢复原价。</p>
      </dd>
    </dl>
      <dl>
      <dt>限时折扣限购：</dt>
      <dd>
        <input id="dialog_xianshi_limit" type="text" class="text w70">
        <em class="add-on">件</em>
        <p class="hint">限购数量，超过限购数量则无法下单</p>
      </dd>
    </dl>
      <dl>
          <dt></dt>
          <dd>
              <input id="dialog_first_order" type="checkbox" class="" value="1">
              <label for="dialog_first_order">仅限首单</label>
          </dd>
      </dl>
    <div class="eject_con">
      <div class="bottom">
