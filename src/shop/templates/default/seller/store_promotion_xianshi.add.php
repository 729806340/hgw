...
<div class="ncsc-form-default">
    ...
    <dl>
      ...
      <dd>
          <input id="xianshi_name" name="xianshi_name" type="text" <?php if (isset($output['xianshi_info']['config_xianshi_id']) && $output['xianshi_info']['config_xianshi_id'] > 0) {?> readonly style="background:#E7E7E7 none;" <?php } ?> maxlength="25" class="text w400" value="<?php echo empty($output['xianshi_info'])?'':$output['xianshi_info']['xianshi_name'];?>"/>
          <span></span>
    ...
    <dl>
      ...
      <dd>
          <input id="xianshi_title" name="xianshi_title" type="text"  maxlength="10" <?php if (isset($output['xianshi_info']['config_xianshi_id']) && $output['xianshi_info']['config_xianshi_id'] > 0) {?> readonly style="background:#E7E7E7 none;" <?php } ?> class="text w200" value="<?php echo empty($output['xianshi_info'])?'':$output['xianshi_info']['xianshi_title'];?>"/>
          <span></span>
    ...
    <dl>
      ...
      <dd>
          <input id="xianshi_explain" name="xianshi_explain" type="text"  maxlength="30" class="text w400" <?php if (isset($output['xianshi_info']['config_xianshi_id']) && $output['xianshi_info']['config_xianshi_id'] > 0) {?> readonly style="background:#E7E7E7 none;" <?php } ?> value="<?php echo empty($output['xianshi_info'])?'':$output['xianshi_info']['xianshi_explain'];?>"/>
          <span></span>
