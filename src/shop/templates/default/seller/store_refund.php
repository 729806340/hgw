...
<form method="get" action="index.php">
  ...
  <table class="search-form">
    <tr>
      ...
      <td class="w80"><select name="order_state">
          <option value="" <?php if($_GET['order_state'] == ''){?>selected<?php }?>>全部</option>
          <option value="20" <?php if($_GET['order_state'] == '20'){?>selected<?php }?>>已支付</option>
          <option value="21" <?php if($_GET['order_state'] == '21'){?>selected<?php }?>>备货中</option>
          <option value="30" <?php if($_GET['order_state'] == '30'){?>selected<?php }?>>已发货</option>
          <option value="40" <?php if($_GET['order_state'] == '40'){?>selected<?php }?>>已完成</option>
        </select></td>
      ...
      <td class="w100"><input style="width: 100px;" type="text" class="text" name="key" value="<?php echo trim($_GET['key']); ?>" /></td>
  ...
  <tbody>
    ...
    <tr class="bd-line" >
      ...
      <td><?php
          ...
          echo $output['state_array'][$seller_state]; ?></td>
...
<script>
	$(function(){
	    ...
	    $('.export').click(function(){
            ...
            location.href="index.php?act=store_refund&op=exportCvs&add_time_from="+add_time_from+"&add_time_to="+add_time_to+"&state="+state+"&type="+type+"&key="+key+"&lock="+"<?php echo $_GET['lock']; ?>";
        })
	});
</script>
