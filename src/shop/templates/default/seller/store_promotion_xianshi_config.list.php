...
<table class="ncsc-default-table">
  ...
  <tbody id="xianshi_list">
    <tr class="bd-line">
      <td></td>
        <td class="tl">
            <?php echo $val['config_xianshi_id'];?>
        </td>
      <td class="tl"><dl class="goods-name">
          <dt><?php echo $val['config_xianshi_name'];?></dt>
        </dl></td>
      <td class="goods-time"><?php echo date("Y-m-d H:i",$val['config_start_time']);?></td>
      <td class="goods-time"><?php echo date("Y-m-d H:i",$val['config_end_time']);?></td>
      <td class="nscs-table-handle">
        ...
        <p><?php echo $lang['nc_delete'];?></p>
          ...
          <?php }else{?>
        <span>
            <a href="index.php?act=store_promotion_xianshi&op=xianshi_add_config&config_xianshi_id=<?php echo $val['config_xianshi_id'];?>" class="btn-mint"> <i class="icon-cog"></i><p>报名</p></a>
        </span>
          <?php }?>
      </td>
    </tr>
