      ...
      <div class="content">
        <ul>
          <?php
			...
			?>
          <li><a target="_blank" <?php if($val['article_url']!=''){?>target="_blank"<?php }?>. href="<?php if($val['article_url']!='')echo $val['article_url'];else echo urlMember('article', 'show', array('article_id'=>$val['article_id']));?>" title="<?php echo $val['article_title']; ?>"><i>&#8226;</i>
    ...
    <div class="container type-a">
      ...
      <div class="content">
        <dl class="focus">
          ...
          <dd>
              <?php echo $lang['store_order_progressing'];?> <strong id="nc_progressing"></strong>
              <a href="index.php?act=store_order">所有订单 <strong id="nc_all"></strong></a>
          </dd>
...
<script>
$(function(){
    <?php if(!empty($output['notice_article'])) {?>
    ajax_form('ajax_jingle', '系统公告', 'index.php?act=seller_center&op=read_article_ajax&article_id=' + <?php echo $output['notice_article']['article_id'];?>, 915);
	<?php }?>
