...
<div class="ncsc-form-default">
  <form method="post"  action="index.php?act=store_setting&op=store_setting" enctype="multipart/form-data" id="my_store_form">
    ...
    <dl>
      ...
      <dl>
          <dt>店铺短语<?php echo $lang['nc_colon'];?></dt>
          <dd>
              <input class="text w200" name="store_slogan" maxlength="20" type="text"  id="store_phone" value="<?php echo $output['store_info']['store_slogan'];?>" />
              <p>App展示</p>
          </dd>
      </dl>
      ...
      <dd>
        <p>
            <div class="QRcode">
              <p><img src="<?php echo '/data/upload/shop/store/' .$_SESSION['store_id'].DS. $_SESSION['store_id'] . '_store.png'; ?>"></p>
			  <a target="_blank" href="<?php echo '/data/upload/shop/store/' .$_SESSION['store_id'].DS. $_SESSION['store_id'] . '_store.png'; ?>">下载二维码</a>
			   | <a title="重新生成二维码" target="_blank"  href="?act=store_goods_online&op=maker_qrcode" style="right:100px" onclick="return confirm('您确定要重新生成二维码吗？');">重新生成二维码</a>
            </div>
            </span></p>
        </dd>
    </dl>
