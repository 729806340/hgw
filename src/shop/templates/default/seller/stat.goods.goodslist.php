...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td>
          <a href="javascript:void(0);" nc_type='showdata' data-param='{"gid":"<?php echo $v['goods_id'];?>"}'>走势图</a>
          <?php if(in_array($_SESSION['store_id'],array(15,10,48,138,171))){?>
              <a href="index.php?act=statistics_goods&op=channel&goods_id=<?php echo $v['goods_id'];?>">渠道分析</a>
          <?php } ?>
      </td>
    </tr>
    <?php }?>
