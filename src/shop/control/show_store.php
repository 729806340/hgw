...
class show_storeControl extends BaseStoreControl {
    ...
    public function indexOp(){
        if(!$this->store_decoration_only) {
            ...
            $fields = "goods_id,goods_commonid,goods_name,goods_jingle,store_id,store_name,goods_price,goods_promotion_price,goods_marketprice,goods_storage,goods_image,goods_freight,goods_salenum,color_id,evaluation_good_star,evaluation_count,goods_promotion_type";
            //得到最新12个商品列表
