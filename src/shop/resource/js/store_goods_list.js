                ...
                $.getJSON('index.php?act=store_goods_online&op=get_goods_list_ajax' , {commonid : _commonid}, function(date){
                    if (date != 'false') {
                        ...
                        $.each(date, function(i, o){
                            ...
                            $('<div class="update_goodscost"><a href="javascript:;" class="ncbtn-mini ncbtn-lavander mt5" onclick="ajax_form(\'ajax_jingle\', \'设置成本价格\', \'index.php?act=store_goods_online&op=update_goodscost&goods_id=' + o.goods_id + '\', \'915\')">设置成本价格</a></div>').appendTo(_li);
