			...
			<div id="divSWFUploadUI">
				...
				<p>
					<span id="spanButtonPlaceholder"></span> <input id="btnCancel"
						type="button" value="取消所有上传" disabled="disabled"
						style="margin-left: 2px; height: 29px; font-size: 8pt;" /> <br />
				</p>
			</div>
			<noscript>
				<div
