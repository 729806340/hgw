...
$lang['stat_areaanalyze_fx']		= '<b>（分销）</b>区域分析';
...
$lang['stat_goods_sale_fx']			= '分销商品销售明细';
$lang['stat_goods_refund']			= '商品退款统计';
...
$lang['stat_goods_pricerange_fx']   = '分销价格销量';
$lang['stat_hotgoods']	            = '热卖商品';
$lang['stat_hotgoods_fx']	        = '分销热卖商品';

$lang['stat_industryscale']	        = '品类规模';
$lang['stat_industryscale_fx']	    = '<b>（分销）</b>品类规模';
$lang['stat_industryrank']	        = '品类排行';
$lang['stat_industryrank_fx']	    = '<b>（分销）</b>品类排行';
$lang['stat_industryprice']	        = '价格分析';
$lang['stat_industryprice_fx']	    = '<b>（分销）</b>价格分析';
$lang['stat_industrygeneral']	    = '概况总览';
$lang['stat_industrygeneral_fx']	= '<b>（分销）</b>概况总览';
...
$lang['stat_validorder_explain']	= "符合以下任何一种条件的订单即为有效订单：1、采用在线支付方式支付并且已付款；2、采用货到付款方式支付并且交易已完成；3、经过退款的取消订单";
$lang['stat_validorder_refund']     = "符合以下条件的退款单即为有效退款单：1、退款状态为已完成；2、商家已经同意退款；";

$lang['stat_fenxiaoindex'] = "分销概述";