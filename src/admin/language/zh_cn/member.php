...
$lang['member_fenxiao_index_manage']		= '渠道管理';
...
$lang['member_fenxiao_manage_subhead']= '分销渠道信息设置管理';
...
$lang['member_fenxiao_index_help1']			= '通过分销渠道管理，你可以进行查看、编辑渠道资料等操作';
$lang['member_fenxiao_index_help2']			= '你可以根据条件搜索渠道，然后选择相应的操作';
