    ...
    <div class="manager">
      ...
      <div class="manager-menu">
        <div class="title">
          ...
          <a href="javascript:void(0);" onclick="CUR_DIALOG = ajax_form('modifyEmail', '修改邮箱', '<?php echo urlAdmin('index', 'modify_email');?>');" style="background: none; font-size: 12px; margin: 0;">修改邮箱</a> </div>
...
<div class="admincp-container unfold">
  <div class="admincp-container-left">
    ...
    <div class="about" title="关于系统" onclick="ajax_form('about', '', '<?php echo urlAdmin('aboutus');?>', 640);"><i class="fa fa-copyright"></i><span>HangoWa.com</span></div>
  </div>
