  ...
  <form id="supplier_add_form" enctype="multipart/form-data" method="post">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="<?php echo $output['supplier_info']['company_name']?>" name="company_name" id="company_name" maxlength="20" class="input-txt">
          <span class="err"></span>
          <p class="notic"></p>
      </dl>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="<?php echo $output['supplier_info']['address']?>" name="address" id="address" class="input-txt">
          <span class="err"></span>
        </dd>
      </dl>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <select id="manage_type" name="manage_type">
                    <option  <?php if($output['supplier_info']['manage_type'] == 'platform') {?> selected="selected" <?php } ?> value="platform">平台商家</option>
                    <option  <?php if($output['supplier_info']['manage_type'] == 'co_construct') {?> selected="selected" <?php } ?> value="co_construct">共建商家</option>
                </select>
                <span class="err"></span>
                <p class="notic">
