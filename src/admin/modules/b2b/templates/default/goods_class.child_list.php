...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=goods_class&op=goods_class&bc_id=<?php echo $output['parent_id']?>" title="返回上级分类列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
      ...
      <thead>
        <tr>
          ...
          <th width="150" class="handle" align="center"><?php echo $lang['nc_handle'];?></th>
            ...
            <th width="70" align="center">父类ID</th>
      ...
      <tbody>
        ...
        <tr data-id="<?php echo $v['gc_id'];?>">
          ...
          <td class="handle">
            ...
            <ul>
              <li><a href="index.php?act=goods_class&op=goods_class_edit&bc_id=<?php echo $v['bc_id'];?>">编辑分类信息</a></li>
              <?php if ($output['deep'] != 3) {?>
              <li><a href="index.php?act=goods_class&op=goods_class_add&bc_pid=<?php echo $v['bc_id'];?>">新增下级分类</a></li>
              <?php }?>
              <?php if ($v['have_child'] == 1) {?>
              <li><a href="index.php?act=goods_class&op=goods_class&bc_id=<?php echo $v['bc_id'];?>">查看下级分类</a></li>
              <?php }?>
              <?php if ($v['have_child'] != 1) { ?>
            ...
            <td><?php echo $v['bc_id']; ?></td>
            <td><?php echo $v['bc_pid']; ?></td>
            <td class="sort"><span title="<?php echo $lang['nc_editable']; ?>" column_id="<?php echo $v['gc_id']; ?>" fieldname="gc_sort" nc_type="inline_edit" class="editable "><?php echo $v['bc_sort']; ?></span></td>
            <td class="name"><span title="<?php echo $lang['nc_editable']; ?>" column_id="<?php echo $v['gc_id']; ?>" fieldname="gc_name" nc_type="inline_edit" class="editable "><?php echo $v['bc_name']; ?></span></td>
