  ...
  <div class="fixed-bar">
      ...
      <div class="subject">
        ...
        <h5>商城所有商品索引及管理</h5>
          ...
          <ul class="tab-base nc-row"><li><a href="index.php?act=supplier&op=my_goods_list&supplier_id=<?php echo $output['supplier_id'];?>" ><span>现有商品</span></a></li><li><a  class="current"><span>商品导入</span></a></li></ul> </div>
  </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?act=supplier&op=get_xml&type=all&supplier_id=<?php echo $output['supplier_id'];?>',
        colModel : [
...
//商品绑定
function  fg_bind(ids,supplier_id){
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "index.php?act=supplier&op=goods_bind",
            data: {"ids":ids,'supplier_id':supplier_id},
