...
<div class="page">
    ...
    <div class="explanation" id="explanation">
        ...
        <ul>
            <li>
                日志开关在data/config/sapb2b.config.php配置文件中设置；目前状态为：<strong><?php echo $output['sap_setting']['log'] ? '开启' : '关闭'; ?></strong>
            </li>
            <li>
                ...
                <dl>
                    ...
                    <dd>
                        <select class="s-select" name="sap_code">
                            ...
                            <option value="sapb2b101">sapb2b101</option>
                            <option value="sapb2b102">sapb2b102</option>
                            <option value="sapb2b201">sapb2b201</option>
                            <option value="sapb2b202">sapb2b202</option>
                            <option value="sapb2b301">sapb2b301</option>
                            <option value="sapb2b401">sapb2b401</option>
                            <option value="sapb2b501">sapb2b501</option>
                        </select>
                    </dd>
                </dl>
                <dl>
...
<script>
    $(function () {
        ...
        $('#ncsubmit').click(function(){
            $("#table").flexOptions({url: 'index.php?act=sapb2b&op=get_xml&sap_search=gsearch&'+$("#formSearch").serialize(),query:'',qtype:'',sap_search:'gsearch'}).flexReload();
        });

        // 高级搜索重置
        $('#ncreset').click(function(){
            $("#table").flexOptions({url: 'index.php?act=sapb2b&op=get_xml'}).flexReload();
            $("#formSearch")[0].reset();
        });

        $("#table").flexigrid({
            url: 'index.php?act=sapb2b&op=get_xml',
            colModel: [
