...
<div class="page">
  ...
  <div class="ncap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      ...
      <input type="hidden" name="op" value="hotgoods_fenxiao" />
...
function getStatdata(type){
	...
	$('#'+type+'_div').load('index.php?act=stat_goods&op=hotgoods_list&source=fenxiao&type='+type+'&choose_gcid='+choose_gcid+'&t=<?php echo $output['searchtime'];?>');
}
