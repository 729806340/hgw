          ...
          <div class="layout-box">
            ...
            <dl>
             ...
             <dl>
              <dt>sap应付发票状态</dt>
              <dd>
                <label><input type="text" value="" name=purchase_sap id="purchase_sap" class="s-input-txt"></label>
                <label><input type="checkbox" value="1" name="jq_query">精确</label>
              </dd>
            </dl>
              <dt>按结算状态筛选</dt>
...
$(function(){
    ...
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            ...
            {display: 'sap应收发票状态', name : 'send_sap', width : 70, sortable : true, align: 'center'},
            {display: 'sap应付发票状态', name : 'purchase_sap', width : 70, sortable : true, align: 'center'},
       ...
       {display: 'sap应收发票状态', name : 'send_sap'},
       {display: 'sap应付发票状态', name : 'purchase_sap'},
