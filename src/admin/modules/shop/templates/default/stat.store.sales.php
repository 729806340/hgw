...
function update_flex(){
    ...
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            ...
            {display: '走势图', name : 'orderamount',  width : 120, sortable : true, align: 'center'},
            {display: '复购率', name : 'reporate',  width : 120, sortable : true, align: 'center'},
            {display: '增长率', name : 'growthrate',  width : 120, sortable : true, align: 'center'}
            ],
        buttons : [
