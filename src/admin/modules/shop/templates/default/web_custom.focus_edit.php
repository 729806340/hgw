...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=web_custom&op=web_config" title="返回<?php echo '板块区';?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
	  ...
	  <ul class="tab-base nc-row">
        <li><a href="index.php?act=web_custom&op=code_edit&web_id=<?php echo $_GET['web_id'];?>"><?php echo '板块区';?></a></li>
  ...
  <div class="homepage-focus" id="homepageFocusTab">
    <div class="title">
      <h3>自定义焦点区域设置</h3>
      <ul class="tab-base nc-row">
        <li><a href="JavaScript:void(0);" form="upload_screen_form"><?php echo '全屏(背景)焦点大图';?></a></li>
        <li><a href="JavaScript:void(0);" class="current" form="upload_focus_form"><?php echo $output['code_focus_list']['show_name'];?></a></li>
    ...
    <form id="upload_screen_form" class="tab-content" name="upload_screen_form" enctype="multipart/form-data" method="post" action="index.php?act=web_config&op=screen_pic" target="upload_pic">
      ...
      <div class="ncap-form-default">
        <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_screen_form').submit();" class="ncap-btn-big ncap-btn-green"><?php echo $lang['web_config_save'];?></a> <a href="index.php?act=web_custom&op=html_update&web_id=<?php echo $output['code_screen_list']['web_id'];?>" class="ncap-btn-big ncap-btn-green"><?php echo $lang['web_config_web_html'];?></a> <span class="web-save-succ" style="display:none;"><?php echo $lang['nc_common_save_succ'];?></span> </div>
      </div>
    </form>
    ...
    <form id="upload_focus_form" class="tab-content" name="upload_screen_form" enctype="multipart/form-data" method="post" action="index.php?act=web_config&op=focus_pic" target="upload_pic" style="display:none;">
      ...
      <div class="ncap-form-default">
        <dl class="row">
          <dt class="tit"><?php echo $output['code_focus_list']['show_name'];?>预览</dt>
      ...
      <div class="ncap-form-default">
        <div class="bot"> <a href="JavaScript:void(0);" onclick="$('#upload_focus_form').submit();" class="ncap-btn-big ncap-btn-green"><?php echo $lang['web_config_save'];?></a> <a href="index.php?act=web_custom&op=html_update&web_id=<?php echo $output['code_focus_list']['web_id'];?>" class="ncap-btn-big ncap-btn-green"><?php echo $lang['web_config_web_html'];?></a> <span class="web-save-succ" style="display:none;"><?php echo $lang['nc_common_save_succ'];?></span> </div>
      </div>
    </form>
  </div>
</div>
