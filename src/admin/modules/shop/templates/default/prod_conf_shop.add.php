...
<div class="page">
  ...
  <form id="refund_form" name="form" method="post" action="index.php?act=sale_analysis&op=addMarket"  enctype="multipart/form-data">
    <div class="ncap-form-default">

        <dl class="row">
            <dt class="tit">店铺名</dt>
            <dd class="opt">
                <input type="text" name="shop_name" class="input-txt"/>
            </dd>
        </dl>
        <dl class="row">
            <dt class="tit">店铺链接</dt>
            <dd class="opt">
                <input type="text" name="shop_url" class="input-txt"/>&nbsp<font style="color: red">*</font>
            </dd>
        </dl>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <select name="status">
                    <option value="2" selected>开启</option>
