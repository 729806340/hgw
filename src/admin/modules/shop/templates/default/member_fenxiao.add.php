...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=member_fenxiao&op=index" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3>渠道管理 - <?php echo $lang['nc_new']?>渠道</h3>
  ...
  <form id="user_form" enctype="multipart/form-data" method="post">
    ...
    <div class="ncap-form-default">
        <dl class="row">
            ...
            <dd class="opt">
                <input type="text" value="" name="member_cn_code" id="member_cn_code" class="input-txt">
                <span class="err"></span>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <input type="text" value="" name="member_en_code" id="member_en_code" class="input-txt">
                <span class="err"></span>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="password" id="member_passwd" name="member_passwd" class="input-txt">
          <span class="err"></span>
