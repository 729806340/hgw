    ...
    $(function(){
        ...
        $("#flexigrid").flexigrid({
            ...
            colModel : [
                ...
                {display: '扣除佣金', name : 'commis_amount', width : 70, sortable : true, align: 'left'},
                {display: '下单日期', name : 'add_time', width : 80, sortable : true, align : 'center'},
                {display: '出账日期', name : 'finnshed_time', width : 80, sortable : true, align: 'center'},
                {display: '发货日期', name : 'push_time', width : 80, sortable : true, align: 'center'},
