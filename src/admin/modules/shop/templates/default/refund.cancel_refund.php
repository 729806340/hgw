...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="javascript:history.back(-1)" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['refund_manage'];?> - 改为商家拒绝“退单编号：<?php echo $output['refund']['refund_sn']; ?>”</h3>
        <h5>客服人员可以撤销退款</h5>
      </div>
    </div>
  </div>
  <form id="post_form" method="post" action="index.php?act=refund&op=cancel_refund&refund_id=<?php echo $output['refund']['refund_id']; ?>">
    ...
    <div class="ncap-form-default">
      ...
      <div class="title">
        ...
        <dl class="row">
            ...
            <dd class="opt"><textarea name="log_msg"></textarea> </dd>
        </dl>
        <dl class="row">
        <dt class="tit">提示</dt>
