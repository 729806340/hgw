...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?act=pyramid_crash&op=get_new_xml&state=<?php echo $_GET['state'];?>',
        colModel : [
            {display: '操作', name : 'operation', width : 160, sortable : false, align: 'center', className: 'handle'},
            {display: '提现人', name : 'crash_user_name', width : 70, sortable : false, align: 'center'},
            {display: '提现人id', name : 'own_member_id', width : 70, sortable : false, align: 'center'},
            {display: '提现编号', name : 'out_crash_number', width: 100, sortable : false, align : 'center'},
            {display: '提现状态', name : 'cash_check_state', width : 120, sortable : false, align: 'center'},
            {display: '付款状态', name : 'pay_state', width : 120, sortable : false, align: 'center'},
            {display: '提现时间', name : 'add_time', width : 120, sortable : false, align: 'center'},
            {display: '提现金额', name : 'out_crash_money', width : 120, sortable : false, align: 'center'}
        ],
        searchitems : [
                {display: '提现人id', name : 'own_member_id'}
        ],
