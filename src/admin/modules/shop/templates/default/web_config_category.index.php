  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="JavaScript:void(0);" class="current"><?php echo '分类区';?></a></li>
      </ul>
    </div>
  </div>
  ...
  <table class="flex-table">
    <thead>
      <tr>
        ...
        <th width="150" align="left">样式标识</th>
    ...
    <tbody>
    <tr>
        <div class="add" title="新增分类板块"><span><i class="fa fa-plus"></i><a href="index.php?act=web_config&op=web_config_category_edit">新增板块</a></span></div></div>
    </tr>
      <?php if(!empty($output['web_list']) && is_array($output['web_list'])){ ?>
      <?php foreach($output['web_list'] as $k => $v){ ?>
      <tr>
        <td class="sign"><i class="ico-check"></i></td>
        <td class="handle"><a class="btn purple" href="index.php?act=web_config&op=web_config_category_edit&web_id=<?php echo $v['web_id'];?>"><i class="fa fa-cog"></i><?php echo $lang['web_config_web_edit'];?></a><a class="btn orange" href="index.php?act=web_config&op=category_code_edit&web_id=<?php echo $v['web_id'];?>"><i class="fa fa-steam"></i><?php echo $lang['web_config_code_edit'];?></a></td>
