...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=web_config&op=web_config_category" title="返回<?php echo '板块区';?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
          ...
          <div class="left">
            <dl id="left_tit">
              ...
              <dd class="tit-txt" >
                ...
                <img src="<?php echo UPLOAD_SITE_URL.'/'.$output['code_tit']['code_info']['pic'];?>" width="30" height="30"/>
  ...
  <form id="upload_tit_form" name="upload_tit_form" enctype="multipart/form-data" method="post" action="index.php?act=web_config&op=upload_pic" target="upload_pic">
    ...
    <div class="ncap-form-default">
      ...
      <div id="upload_tit_type_txt" <?php if($output['code_tit']['code_info']['type'] != 'txt'){ ?>style="display:none;"<?php } ?>>
        ...
        <dl class="row">
          <dt class="tit"><?php echo '链接地址';?></dt>
          <dd class="opt">
            <input class="input-txt" type="text" name="tit[url]" id="tit_url" value="<?php echo $output['code_tit']['code_info']['url'];?>">
            <p class="notic"><?php echo '如http://www.hangowa.com/';?></p>
          </dd>
        </dl>
      </div>
