...
<script>
$(function(){
    var flexUrl = 'index.php?act=promotion_xianshi&op=config_xianshi_store_xml&config_xianshi_id=<?php echo $_GET['config_xianshi_id'];?>';

    $("#flexigrid").flexigrid({
        url: flexUrl,
        colModel: [
            // {display: '操作', name: 'operation', width: 150, sortable: false, align: 'center', className: 'handle'},
            {display: '编号', name: 'xianshi_id', width: 70, sortable: false, align: 'left'},
            {display: '店铺名称', name: 'store__name', width: 280, sortable: false, align: 'left'},
