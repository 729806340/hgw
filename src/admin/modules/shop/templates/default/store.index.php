        ...
        <div id="searchCon" class="content">
          <div class="layout-box">
            ...
            <dl>
              <dt>公司名称</dt>
              <dd>
                <input type="text" value="" name="store_company_name" id="store_company_name" class="s-input-txt">
              </dd>
            </dl>
            <dl>
              <dt>店主账号</dt>
...
$(function(){
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            ...
            {display: '公司名称', name : 'store_company_name', width : 150, sortable : false, align: 'left'},
