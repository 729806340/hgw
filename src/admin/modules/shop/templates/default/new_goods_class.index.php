    ...
    <form method='post'>
        ...
        <table class="flex-table">
            ...
            <tr>
                ...
                <th width="80" align="center">APP端显示</th>
                <th width="100" align="center">APP端图片</th>
            ...
            <ul>
                ...
                <?php } ?>
                <li><a href="index.php?act=new_goods_class&op=nav_edit&gc_id=<?php echo $v['gc_id']; ?>">编辑分类导航</a></li>
                <?php if ($v['have_child'] != 1) { ?>
                ...
                <?php } ?>
                        ...
                        <td><?php echo empty($v['app_show'])?'否':'是';?></td>
...
<script type="text/javascript">
    ...
    function fg_operation(name, bDiv) {
        if (name == 'add') {
            window.location.href = 'index.php?act=new_goods_class&op=goods_class_add';
        } else if (name == 'del') {
            ...
            window.location.href = 'index.php?act=new_goods_class&op=goods_class_export';
        }
    }
    function fg_del(ids) {
