    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <select name="type">
                    <option value="0" <?php echo $output['config_xianshi_info']['type'] == 0 ? 'selected' : '';?> >请选择类型</option>
                    <option value="1" <?php echo $output['config_xianshi_info']['type'] == 1 ? 'selected' : '';?>>物流</option>
                    <option value="2" <?php echo $output['config_xianshi_info']['type'] == 2 ? 'selected' : '';?>>自提</option>
                </select>
            </dd>
        </dl>
    </div>
