...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <div class="subject">
                <h3><?php echo $lang['stat_goods_refund'];?></h3>
                <h5>平台针对商品退款的各项数据统计</h5>
            </div>
    ...
    <div class="explanation" id="explanation">
        ...
        <ul>
            <li><?php echo $lang['stat_validorder_refund'];?></li>
            <li>以下列表为符合搜索条件的有效订单中所有商品数据，及其时间段内的商品名称、商品SKU、退款单量、退款商品数量、退款金额</li>
            <li>默认按照“退单量”降序排列</li>
        </ul>
    </div>
            ...
            <div id="searchCon" class="content">
                <div class="layout-box">
                    ...
                    <dl>
                        ...
                        <dd>
                            <label>
                                <select name="buyer_name" id="channel" class="class-select">
...
<script>
    ...
    function update_flex(){
        $("#flexigrid").flexigrid({
            url: 'index.php?act=stat_goods&op=get_xml_refund&'+$("#formSearch").serialize(),
            colModel : [
                //{display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},
                {display: '商品名称', name : 'goods_name', width : 250, sortable : false, align: 'center'},
                {display: '商品SKU', name : 'goods_id', width : 150, sortable : true, align: 'center'},
                {display: '退款单量', name : 'total',  width : 120, sortable : true, align: 'center'},
                {display: '退款商品数量', name : 'num',  width : 120, sortable : true, align: 'center'},
                {display: '退款金额', name : 'amount',  width : 120, sortable : true, align: 'center'},
            ],
            buttons : [
    ...
    function fg_operation(name, bDiv){
        var stat_url = 'index.php?act=stat_goods&op=get_xml_refund';
