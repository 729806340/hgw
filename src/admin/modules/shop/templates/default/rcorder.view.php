...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="javascript:history.back(-1)" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3>分销订单重建</h3>
        <h5>分销订单发生部分退款时，使用该功能重新生成未退款商品的订单</h5>
      </div>
    </div>
  </div>
  <div class="ncap-order-style">
	...
	<div class="ncap-order-flow" style="background-color:#fff;margin-bottom:0;">
		<ol class="num5">
        <li class="current">
          &nbsp;
        </li>
    ...
    <div class="ncap-order-details">
      ...
      <div class="tabs-panels">
		...
		<form id="rcorder_form" method="post" action="index.php?act=order&op=rc_order&order_id=<?php echo intval($_GET['order_id']);?>" >
        <div class="goods-info">
          <h4><?php echo $lang['product_info'];?></h4>
		  <h6 style="color:#ff3300;">选择未退款的商品</h6>
          <table>
            <thead>
              <tr>
            ...
            <tbody>
              ...
              <?php $i++;?>
              <tr>
				<td><input type="checkbox" class="cgoods" name="gids[]" value="<?php echo $goods['goods_id'];?>" ></td>
		  ...
		  <br />
		  <p>退款金额：<input type="text" name="refund_amount" value = "" autocomplete="off" id="refund_amount" />
			<input type="hidden" name="total_goods" value="<?php echo count($output['order_info']['goods_list']); ?>" />
			<a id="submitBtn" class="ncap-btn-big ncap-btn-green" href="JavaScript:void(0);" style="height:10px; font:bold 10px/10px arial;" >重建</a>
		  </p>
        </div>
		</form>
