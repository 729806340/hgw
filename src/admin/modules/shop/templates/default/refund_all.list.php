...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li>买家提交申请，商家同意并经平台确认后，退款金额以预存款的形式返还给买家（充值卡部分只能退回到充值卡余额）。
          <a href="JavaScript:void(0);" class="ncap-btn ncap-btn-green" onclick="importRefund()">导入退款单</a>
          <input id="refund-file" name="file" type="file" size="30" hidefocus="true" style="display: none;">
          <a href="/admin/public/refundtpl.csv" class="ncap-btn">下载模板</a>
