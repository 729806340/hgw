...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="JavaScript:void(0);" class="current"><?php echo '自定义板块区';?></a></li>
        <li><a href="index.php?act=web_config&op=focus_edit"><?php echo '焦点区';?></a></li>
        <li><a href="index.php?act=web_config&op=web_tab_self"><?php echo '自营区';?></a></li>
      </ul>
    </div>
  </div>
  ...
  <table class="flex-table">
    ...
    <tr>
      ...
      <th width="150" align="left">样式标志</th>
    ...
    <tbody>
    <tr>
      <div class="add" title="新增频道"><span><i class="fa fa-plus"></i><a href="index.php?act=web_config&op=web_tab_custom_edit">新增板块</a></span></div></div>
    </tr>
...
<?php if(!empty($output['web_list']) && is_array($output['web_list'])){ ?>
  <?php foreach($output['web_list'] as $k => $v){ ?>
    <tr>
      ...
      <td class="handle">
        <a class="btn purple" href="index.php?act=web_config&op=web_tab_custom_edit&web_id=<?php echo $v['web_id'];?>"><i class="fa fa-cog"></i><?php echo $lang['web_config_web_edit'];?></a>
      <!-- <?php /*if($k == 1){*/?>
         <a class="btn purple" href="index.php?act=web_config&op=tab_custom_adv&web_id=<?php /*echo $v['web_id'];*/?>"><i class="fa fa-steam"></i><?php /*echo $lang['web_config_code_adv'];*/?></a>
           --><?php /*}else{*/?>
         <a class="btn orange" href="index.php?act=web_config&op=tab_custom_code_edit&web_id=<?php echo $v['web_id'];?>"><i class="fa fa-steam"></i><?php echo $lang['web_config_code_edit'];?></a>
      <!-- --><?php /*}*/?>
