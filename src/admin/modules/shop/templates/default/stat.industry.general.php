...
function update_flex(){
    ...
    $("#flexigrid").flexigrid({
        url: 'index.php?act=stat_industry&op=get_general_xml&source=<?php echo $output['source'];?>&choose_gcid='+choose_gcid,
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?act=stat_industry&op=general_list&source=<?php echo $output['source'];?>';
