...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=web_config&op=web_tab_custom" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
...
<script>
  $(function(){
    $("#flexigrid").flexigrid({
      url: 'index.php?act=web_config&op=get_adv_xml&ap_id=46;?>',
      colModel : [
