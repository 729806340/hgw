...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=web_config&op=web_config" title="返回<?php echo '板块区';?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
	  ...
	  <ul class="tab-base nc-row">
		...
		<li><a href="index.php?act=web_custom&op=focus_edit&web_id=<?php echo $_GET['web_id'];?>"><?php echo '焦点区';?></a></li>
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
  ...
  <div class="ncap-form-all">
    <div class="title">
      ...
      <a href="index.php?act=web_custom&op=web_edit&web_id=<?php echo $output['web_array']['web_id'];?>">设置该板块色彩</a> </div>
    <dl class="row">
      <dt class="tit">
  ...
  <div class="bot"><a href="index.php?act=web_custom&op=web_html&web_id=<?php echo $_GET['web_id'];?>" class="ncap-btn-big ncap-btn-green" id="submitBtn"><?php echo $lang['web_config_web_html'];?></a> </div>
</div>
