    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a href="JavaScript:void(0);" class="current">店铺数据列表</a></li>
...
<script type="text/javascript">
    function update_flex(){
        $("#flexigrid").flexigrid({
            url: 'index.php?act=sale_analysis&op=getShopXml&'+$("#formSearch").serialize(),
            colModel : [
                ...
                {display: '销量', name : 'sales', width: 150, sortable : false, align : 'center'},
                {display: '抓取时的累计量', name : 'total_sales', width: 150, sortable : false, align : 'center'},
    ...
    function fg_csv(ids) {
        id = ids.join(',');
        window.location.href ='index.php?act=sale_analysis&op=exportShop&id=' + id+'&'+$("#formSearch").serialize();
    }
    //展示搜索时间框
    ...
    $(function () {
        ...
        $('#ncsubmit').click(function(){
            $("#flexigrid").flexOptions({url: 'index.php?act=sale_analysis&op=getShopXml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
            update_flex();
        });
    });
</script>