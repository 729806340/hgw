...
<div class="page">
  ...
  <table class="flex-table">
    ...
    <tbody>
	  <tr>
		<div class="add" title="新增频道"><span><i class="fa fa-plus"></i><a href="index.php?act=web_custom&op=web_edit">新增板块</a></span></div></div>
	  </tr>
      ...
      <tr>
        ...
        <td class="handle"><a class="btn purple" href="index.php?act=web_custom&op=web_edit&web_id=<?php echo $v['web_id'];?>"><i class="fa fa-cog"></i><?php echo $lang['web_config_web_edit'];?></a><a class="btn orange" href="index.php?act=web_custom&op=code_edit&web_id=<?php echo $v['web_id'];?>"><i class="fa fa-steam"></i><?php echo $lang['web_config_code_edit'];?></a></td>
