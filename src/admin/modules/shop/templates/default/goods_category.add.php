...
<div class="page">
    ...
    <form id="goods_category_form" enctype="multipart/form-data" method="post">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                <dt class="tit">
                    <label for="cat_name"><em>*</em><?php echo $lang['goods_class_index_name']; ?></label>
                </dt>
                <dd class="opt">
                    <input type="text" value="" name="cat_name" id="cat_name" maxlength="20" class="input-txt">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <select name="parent_id" id="parent_id">
                        ...
                        <?php if(!empty($output['cat_list'])){?>
                            <?php foreach ($output['cat_list'] as $k=>$v) {?>
                                <option value="<?php echo $v['cat_id']?>" <?php if($output['parent_id'] == $v['cat_id']){ echo "selected='selected'";}?>><?php echo $v['cat_name']?></option>
                                <?php if(!empty($v['child'])){?>
                                    <?php foreach($v['child'] as $ck=>$cv){?>
                                        <option value="<?php echo $cv['cat_id']?>" <?php if($output['parent_id'] == $cv['cat_id']){ echo "selected='selected'";}?>>&nbsp;&nbsp;<?php echo $cv['cat_name'];?></option>
                                        <?php if(!empty($cv['child'])){?>
                                            <?php foreach ($cv['child'] as $ck2=>$cv2) {?>
                                                <option value="<?php echo $cv2['cat_id'];?>"<?php if($output['parent_id'] == $cv2['cat_id']){ echo "selected='selected'";}?>>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $cv2['cat_name'];?></option>
                                            <?php }?>
                                        <?php }?>
                                    <?php }?>
                                <?php }?>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="" name="cat_link" id="cat_link" maxlength="255" class="input-txt">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label for="cat_link">wap分类链接</label>
                </dt>
                <dd class="opt">
                    <input type="text" value="" name="wap_link" id="wap_link" maxlength="255" class="input-txt">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
                        <label for="brand_recommend1" class="cb-enable" title="是">是</label>
                        <label for="brand_recommend0" class="cb-disable selected" title="否">否</label>
                        <input id="brand_recommend1" name="disable" value="true" type="radio">
                        <input id="brand_recommend0" name="disable" checked="checked" value="false" type="radio">
                    </div>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="0" name="cat_sort" id="cat_sort" class="input-txt">
                    <span class="err"></span>
