...
<?php } ?>
<div class="index_block explode4">
  <?php if($item_edit_flag) { ?>
  <h3>模型版块布局-一行4张图片</h3>
  <?php } ?>
  <div class="title">
  ...
  <div nctype="item_content" class="content">
    ...
    <div nctype="item_image" class="item"> <img nctype="image" src="<?php echo getMbSpecialImageUrl($item_value['image']);?>" alt="" width="110px;">
        </br>
            <span><?php echo $item_value['titlebelow'];?></span>
