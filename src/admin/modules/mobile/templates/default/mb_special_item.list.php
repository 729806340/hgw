...
<div class="page"> 
  <!-- 页面导航 -->
  <div class="fixed-bar">
    <div class="item-title"><?php if ($output['special_id'] > 0&&$output['special_id'] <99999999) {?><a class="back" href="index.php?act=mb_special&op=special_list" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a><?php }?>
      <div class="subject">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      ...
      <li>App仅首页可以添加"模型版块布局A", <strong>其他界面不得增删布局</strong>，具体使用请查看操作手册</li>
    </ul>
  </div>
