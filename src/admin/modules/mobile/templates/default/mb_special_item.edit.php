      ...
      <dl class="row">
        ...
        <dd class="opt">
          <select id="dialog_item_image_type" name="" class="vatop">
            ...
            <option value="miaosha">秒杀编号</option>
            <option value="url">链接</option>
            <option value="cate">分类编号_小程序</option>
            <option value="voucher">代金券编号_小程序</option>
            <option value="red_packet">红包编号_小程序</option>
            <option value="wei_url">小程序连接_小程序</option>
            <option value="wei_msg">弹出消息_小程序</option>
            <option value="wei_xianshi">秒杀列表_小程序</option>
            <option value="wei_pyramid">分销中心_小程序</option>
          </select>
          <input id="dialog_item_image_data" type="text" class="txt w100 marginright marginbot vatop">
    ...
    $(document).ready(function(){
        ...
        function change_image_type_desc(type) {
            ...
            if(type != '') {
                ...
                desc_array['store'] = '店铺编号会跳转到指定的店铺详细页面，输入框填写店铺编号。（仅App适用）';
                desc_array['article'] = '文章编号会跳转到指定的文章详细页面，输入框填写文章编号。（仅App适用）';
