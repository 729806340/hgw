  ...
  <form id="post_form" method="post" name="form1" action="<?php echo urlAdminMobile('mb_payment', 'payment_save');?>">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input name="alipay_appid" id="alipay_appid" value="<?php echo $output['payment']['payment_config']['alipay_appid'];?>" class="input-txt" type="text">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
...
$(document).ready(function(){
	$('#post_form').validate({
        ...
        messages : {
            ...
            alipay_appid : {
                required : '<i class="fa fa-exclamation-circle"></i>应用id能为空'
            },
        }
		<?php } ?>
		<?php if ($output['payment']['payment_code'] == 'wxpay') { ?>
