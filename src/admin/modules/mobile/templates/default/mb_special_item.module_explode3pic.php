...
<div class="index_block explode3">
  ...
  <div class="title">
    ...
    <div class="title">
        <?php if($item_edit_flag) { ?>
            <h5>标题3：</h5>
            <input id="home1_title2" type="text" class="txt w200" name="item_data[title2]" value="<?php echo $item_data['title2'];?>">
        <?php } else { ?>
            <span><?php echo $item_data['title2'];?></span>
        <?php } ?>
    </div>
    <div class="title">
        <?php if($item_edit_flag) { ?>
            <h5>副标题3：</h5>
            <input id="home1_stitle2" type="text" class="txt w200" name="item_data[stitle2]" value="<?php echo $item_data['stitle2'];?>">
        <?php } else { ?>
            <span><?php echo $item_data['stitle2'];?></span>
        <?php } ?>
    </div>
