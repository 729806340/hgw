  ...
  <form id="post_form" method="post" name="form1" action="index.php?act=refund&op=edit_reason&reason_id=<?php echo $output['reason']['reason_id']; ?>">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dl class="row">
            <dt class="tit">
                <label for="is_aftersale"><em>*</em>类别</label>
            </dt>
            <dd class="opt">
                <input name="is_aftersale" value="0" type="radio" <?php if(empty($output['reason']['is_aftersale'])) echo "checked";?>>售前
                <input name="is_aftersale" value="1" type="radio" <?php if(!empty($output['reason']['is_aftersale'])) echo "checked";?>>售后
                <span class="err"></span>
            </dd>
        </dl>
      <dl class="row">
