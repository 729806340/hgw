...
<div class="page">
  ...
  <form id="store_class_form" method="post" enctype="multipart/form-data">
    <input type="hidden" name="form_submit" value="ok" />
      <input type="hidden" name="copy_id" value="<?php echo $output['config_xianshi_info']['config_tuan_id']?>">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="<?php echo $output['config_xianshi_info']['config_tuan_name']?>" name="config_xianshi_name" id="config_xianshi_name" class="input-txt">
          <span class="err"></span>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="<?php echo $output['config_xianshi_info']['config_tuan_title']?>" name="config_xianshi_title" id="config_xianshi_title" class="input-txt">
          <span class="err"></span>
      ...
      <dl class="row">
        ...
        <dd class="opt">
            <?php showAdminEditor('article_content', $output['config_xianshi_info']['config_tuan_name']);?>
        </dd>
      </dl>
        <dl class="row">
        <dt class="tit">
        ...
        <dd class="opt">
            <input readonly id="query_start_date" placeholder="请选择起始时间" name=query_start_date value="<?php echo date('Y-m-d H:i',$output['config_xianshi_info']['config_start_time']+86400)?>" type="text" class="s-input-txt" />
          <span class="err"></span>
        ...
        <dd class="opt">
            <input readonly id="query_end_date" placeholder="请选择结束时间" name="query_end_date" value="<?php echo date('Y-m-d H:i',$output['config_xianshi_info']['config_end_time']+86400)?>" type="text" class="s-input-txt" />
          <span class="err"></span>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <input readonly id="send_product_date" placeholder="发货时间" name="send_product_date" value="<?php echo date('Y-m-d H:i',$output['config_xianshi_info']['send_product_date']+86400)?>" type="text" class="s-input-txt" />
                <span class="err"></span>
