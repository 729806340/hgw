...
<script>
    $(function(){
        var flexUrl = 'index.php?act=tuan_config&op=tuan_seckill_xml&config_tuan_id=<?php echo $_GET['config_tuan_id']?>';
        $("#flexigrid").flexigrid({
            url: flexUrl,
            colModel: [
                {display: '操作', name: 'operation', width: 150, sortable: false, align: 'center', className: 'handle'},
                {display: '编号', name: 'tuan_config_goods_id', width: 70, sortable: false, align: 'left'},
                {display: '活动名称', name: 'goods_name', width: 280, sortable: false, align: 'left'},
                {display: '活动标题', name: 'goods_title', width: 120, sortable: false, align: 'center'},
                {display: '购买限制', name: 'lower_limit', width: 120, sortable: false, align: 'center'},
                {display: '状态', name: 'state', width: 120, sortable: false, align: 'center'},
            ...
            buttons: [
                {
                    display: '<i class="fa fa-plus"></i>新增秒杀活动',
                    name: 'add',
                    bclass: 'add',
                    title: '新增秒杀活动',
                    onpress: function() {
                        location.href = '?act=tuan_config&op=tuan_seckill_add&tuan_config_id=<?php echo $_GET['config_tuan_id']?>';
                    }
                },
            ],
