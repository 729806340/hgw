        ...
        <div class="ncap-form-default">
                ...
                <dd class="opt">
                    <?php if (!empty($output['info']['sn_image2'])) { ?>
                        <img onload="javascript:DrawImage(this,160,160);"
                             src="<?php echo UPLOAD_SITE_URL . DS . $output['info']['sn_image1']; ?>"/>
                    <?php } ?>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <?php if (!empty($output['info']['sn_image2'])) { ?>
                        <img onload="javascript:DrawImage(this,160,160);"
                             src="<?php echo UPLOAD_SITE_URL . DS . $output['info']['sn_image2']; ?>"/>
                    <?php } ?>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            ...
            <dl class="row">
                <dt class="tit">
                    <label><?php echo "支付方式"; ?></label>
                </dt>
                <dd class="opt">
                    <?php echo $output['deposit_type'] == '1'; ?>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            ...
            <?php if ($output['info']['state'] == '待审核') { ?>
                <div class="bot">
                    <a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green"
                       id="submitSuccess"><?php echo "审核通过"; ?></a>
                    <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    <a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-red"
                       id="submitFail"><?php echo "审核不通过"; ?></a>
                </div>
            <?php } ?>
        </div>
    </form>
