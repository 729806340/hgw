...
<div class="page">
  ...
  <div class="ncap-form-default">
   ...
   <dl class="row">
    ...
    <?php if (!empty(output['return']['express_id']) && !empty($output['return']['invoice_no'])) { ?>
        <dl class="row">
            <dt class="tit">退货物流</dt>
            <dd class="opt">物流公司： <?php echo $output['express_list'][$output['return']['express_id']]['e_name'] ?> 运单号：<?php echo $output['return']['invoice_no']; ?></dd>
        </dl>
      <?php }?>
    <dl class="row">
      ...
      <dd class="opt">
        ...
        <?php } ?>
        <?php } ?>
          <p><a href="javascript:;" onclick="ajax_form('upload_img', '上传凭证', 'index.php?act=refund&op=upload_img&refund_id=<?php echo $output['return']['refund_id'];?>', 640,0);">上传凭证</a></p>
      </dd>
    </dl>
     <div class="title">
      <h3>商家退款退货处理</h3>
