...
<div class="page">
  ...
  <form id="post_form" method="post" action="index.php?act=return&op=kefu_edit&return_id=<?php echo $output['return']['refund_id']; ?>">
	  ...
	  <dl class="row">
        ...
        <dd class="opt">
			...
			<?php foreach ( $output['refund_way'] as $k => $v ) { ?>
				...
				<option <?php if ($output['return']['refund_way'] == $k) echo "selected"; ?> value="<?php echo $k ; ?>" > <?php echo $v ; ?> </option>
