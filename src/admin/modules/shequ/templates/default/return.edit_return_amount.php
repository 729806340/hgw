...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="javascript:history.back(-1)" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['refund_manage'];?> - 修改退货金额“退单编号：<?php echo $output['return']['refund_sn']; ?>”</h3>
        <h5>客服人员可以修改退款金额</h5>
      </div>
    </div>
  </div>
  <form id="post_form" method="post" action="index.php?act=return&op=edit_return_amount&refund_id=<?php echo $output['return']['refund_id']; ?>">
