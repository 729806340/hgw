    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <input type="radio" name="wuliu_type" value="1" <?php echo $output['class_array']['type_id']=='1'?"checked":"" ?>>&nbsp;自提
                <input type="radio" name="wuliu_type" value="0" <?php echo $output['class_array']['type_id']=='0'?"checked":"" ?>>&nbsp;物流
            </dd>
        </dl>
        <dl class="row">
