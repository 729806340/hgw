...
<div class="page" style="padding: 10px;">
    <div class="ncap-order-style">
        ...
        <form id="punish_form" method="post" action="index.php?act=order&op=add_punish"  enctype="multipart/form-data">
...
<script type="text/javascript">
    $(function () {
        $('#submitBtn').click(function (e) {
            ...
            $.ajax({url: 'index.php?act=order&op=add_punish',
                type: 'POST',
                dataType: 'json',
                data: {order_sn:order_sn,cost_price:cost_price,cost_remark:cost_remark,form_submit:'ok'}}).done(function (res) {
                console.log(res);
                if(!res.state){
