        ...
        <dd class="opt nobg nopd nobd nobs">
          <div class="ncap-account-container">
            ...
            <ul class="ncap-account-container-list">
              ...
              <li>
                <label>
                  <input type="checkbox" class="checkbox" name="cache[]" value="goods_category" >自定义分类</label>
              </li>
              <li>
                <label>
              ...
              <li>
                <label>
                  <input type="checkbox" class="checkbox" name="cache[]" id="member_fenxiao" value="member_fenxiao" >
                  分销会员</label>
              </li>
            </ul>
          </div>
