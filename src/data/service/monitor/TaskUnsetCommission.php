...
class TaskUnsetCommission extends Task
{
...
AND commis_rate=200;';
    ...
    {
        return 'unsetCommission';
    }

    public function getName()
    {
        return '未设置佣金的平台商家订单商品列表';
    }

    public function getTitle()
    {
        return date('Y-m-d').'未设置佣金的平台商家订单商品提醒';
    }

    public function getDescription($count=0)
    {
        return '系统监测到 <b>'.$count.'</b> 条订单商品为平台商家订单商品，但是商品佣金未设置，请立即登录后台补充完整相关数据；';
    }
