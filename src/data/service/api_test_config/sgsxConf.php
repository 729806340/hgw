        ...
        return array(
            ...
            'getRefund'=>array(
                ...
                'form'=>array(
                    ...
                    array('label'=>'订单页码','item_type'=>1,'name'=>'page','is_null'=>0,'type'=>1,'comment'=>'(列表页码 默认值：1)'),
                    array('label'=>'单页大小','item_type'=>1,'name'=>'page_size','is_null'=>0,'type'=>1,'comment'=>'(每页显示数量 默认值：100，最大值：100)'),
                )
            ),
            'pushShip'=>array(
                'comment'=>'',
