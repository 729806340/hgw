...
<style>
    ...
    .nongmaotehui ul li .goods-img .speed_qrcode{  background: url('/shop/img/mart-bg.png') repeat; display: none; position: absolute; left: 0; top: 0; width:160px; height: 160px;}
    .nongmaotehui ul li .goods-img .speed_qrcode .ewm{ width: 80px; height: 80px; margin: 20px auto 0 auto; background: #fff;padding: 10px;}
    .nongmaotehui ul li .goods-img .speed_qrcode .ewm img{ width: 80px !important; height:80px !important;}
    .nongmaotehui ul li .goods-img .speed_qrcode p{ text-align: center; line-height: 35px; color: #fff; font-size: 14px;}
                ...
                <?php if (is_array($val) && !empty($val)) { ?>
                    <li>
                        <div class="goods-img">
                            ...
                            <div class="speed_qrcode">
                                <div class="ewm speed_mart_code" data-src="<?php echo $val['pic_url'];?>"></div>
                                <p>扫描微信二维码购买</p>
                            </div>
                        </div>
...
<script>
    $(function(){
        ...
        $(".nongmaotehui ul li").hover(function(){
            $(this).find(".speed_qrcode").show();
        },function(){
            $(this).find(".speed_qrcode").hide();
        })
    })
</script>