  ...
  <div nctype="item_content" class="content">
    <h5>内容：</h5>
		...
		<select name="item_template">
			<option value ="default" <?php if('default'==$item_info['item_template']) {echo "selected";} ?> >四张图均宽样式</option>
            <option value ="custom" <?php if('custom'==$item_info['item_template']) {echo "selected";} ?> >自定义图片样式</option>
		</select>
