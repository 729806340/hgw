...
<div class="index_block goods-list">
  <div nctype="item_content" class="content">
    ...
    <div nctype="item_image" class="item">
      <div class="goods-pic"><a href=""><img nctype="goods_image" shopwwi-url="<?php echo cthumb($item_value['goods_image']);?>" rel='lazy' src="<?php echo SHOP_SITE_URL;?>/img/loading.gif" alt=""></a></div>
