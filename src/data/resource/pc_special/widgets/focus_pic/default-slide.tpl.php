...
.flexslider .flex-control-nav a{display:inline-block;width:14px;height:14px;line-height:40px;overflow:hidden; background:url(../../js/dot.png) right 0 no-repeat; cursor:pointer;}
