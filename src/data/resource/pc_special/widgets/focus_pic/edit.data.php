  ...
  <div nctype="item_content" class="content">
    <h5>内容：</h5>
		...
		<select name="item_template">
			<option value ="default" <?php if('default-slide'==$item_info['item_template']) {echo "selected";} ?> >默认焦点图滚动样式</option>
			<option value ="static" <?php if('static'==$item_info['item_template']) {echo "selected";} ?> >一张静态图样式</option>
		</select>
