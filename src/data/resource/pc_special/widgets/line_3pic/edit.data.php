  ...
  <div nctype="item_content" class="content">
    <h5>内容：</h5>
		...
		<select name="item_template">
			...
			<option value ="slide_tab" <?php if('slide_tab'==$item_info['item_template']) {echo "selected";} ?> >三张图带选项卡切换</option>
			<option value ="tab_date" <?php if('tab_date'==$item_info['item_template']) {echo "selected";} ?> >三张选项卡图</option>
            <option value ="wid1065" <?php if('wid1065'==$item_info['item_template']) {echo "selected";} ?> >宽度1065</option>
            <option value ="one_line" <?php if('one_line'==$item_info['item_template']) {echo "selected";} ?> >40-20-40</option>
		</select>
