  ...
  if (typeof define === 'function' && define.amd) {
    ...
    $[_PLUGIN_].prototype = {
        ...
        settingDOM : function (){
            ...
            /******/
           this.resourceHref = this.container.find('a').map(function(i,e){return e.href;});
            var ulDOM = this.container.html('<ul class="dnSlide-list"></ul>').find('.dnSlide-list');

            jQuery.each(this.resourceSrcArr , function(i,e){
                ulDOM.append('<li class="dnSlide-item"><a href="'+_this_.resourceHref[i]+'" target="_blank"><img class="slide-img" src="'+_this_.resourceSrcArr[i]+'" width="100%"></a></li>');
            });
