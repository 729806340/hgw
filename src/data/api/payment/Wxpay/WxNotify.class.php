...
class WxNotify extends \WxPayNotify
{
    ...
    public function setConfig($payment_info = array()) {
	...
	public function NotifyProcess($data, &$msg)
	{
		...
		if (in_array($data['attach'],array('v','r'))) {
		    ...
		    $order_pay_info = D('order')->getOrderPayInfo(array('pay_sn'=> $data['out_trade_no']));
		...
		\Common\Util\QueueClient::push('addConsume', array('member_id'=>$log_buyer_id,'member_name'=>$log_buyer_name,
