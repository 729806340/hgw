 ...
 * 支付宝接口类
 */
namespace Common\Service\Payment\Alipay;
...
class Client{
    ...
    public function get_payurl(){
    	$this->parameter = array(
            ...
            'notify_url'	    => U('Home/payment/notify_url',array('payment_code'=>'alipay')),	//通知URL
            'sign_type'		    => 'MD5',				//签名方式
            'return_url'	    => U('Home/payment/return_url',array('payment_code'=>'alipay')),	//返回URL
            ...
            'price'             => C('ON_DEV')?0.01:$this->order['api_pay_amount'],//订单总价
            'quantity'          => 1,//商品数量
            'total_fee'         => 0,//物流配送费用
