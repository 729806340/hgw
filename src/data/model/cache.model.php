...
class cacheModel extends Model {
    ...
    private function _admin_menu() {
        ...
        if (file_exists(BASE_PATH.DS.ADMIN_MODULES_B2B.'/include/menu.php')) {
            require(BASE_PATH.DS.ADMIN_MODULES_B2B.'/include/menu.php');
        }
        if (file_exists(BASE_PATH.DS.ADMIN_MODULES_SHEQU.'/include/menu.php')) {
            require(BASE_PATH.DS.ADMIN_MODULES_SHEQU.'/include/menu.php');
        }
        return $_menu;
    }
    /**
