...
class shequ_goods_classModel extends Model
{
    /**
     * 缓存数据
     */
    ...
    public function __construct() {
        parent::__construct('shequ_goods_class');
    }
    ...
    public function getGoodsClassList($condition, $field = '*') {
        $result = $this->table('shequ_goods_class')->field($field)->where($condition)->order('gc_parent_id asc,gc_sort asc,gc_id asc')->limit(false)->select();
        return $result;
    }
