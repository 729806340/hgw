...
define("BASE_SHIP_EXCELPATH" ,BASE_UPLOAD_PATH."/ship");
...
define('ATTACH_B2B_GOODS','b2b/goods');
define('ATTACH_BRAND','shop/brand');
define('ATTACH_GOODS_CLASS','shop/goods_class');
define('ATTACH_GOODS_CATEGORY','shop/goods_category');
...
define('ATTACH_ADMIN_ATTACHMENT','admin/attachment');

define('TPL_B2B_NAME','default');
...
define('ADMIN_MODULES_B2B', 'modules/b2b');
define('ADMIN_MODULES_SHEQU', 'modules/shequ');
/*
 * 商家入驻状态定义
 */
//新申请
...
// 拼团已支付
define('ORDER_STATE_TUAN_PAY', 15);
//已支付
define('ORDER_STATE_PAY', 20);
//备货中
define('ORDER_STATE_PREPARE', 21);
//部分发货
define('ORDER_STATE_PART_SEND', 25);
//已发货
define('ORDER_STATE_SEND', 30);
//已收货，交易成功
define('ORDER_STATE_SUCCESS', 40);
//订单超过N小时未支付自动取消
define('ORDER_AUTO_CANCEL_TIME', 0.5);
//订单超过N天未收货自动收货
...
define('B2B_SITE_URL', $config['b2b_site_url']);
...
define('B2B_modules_URL', $config['b2b_modules_url']);
define('MOBILE_SITE_URL', $config['mobile_site_url']);
define('WEI_PROGRAM_URL', $config['wei_program_url']);
define('WEI_UPLOAD_URL', $config['wei_upload_url']);
...
define('ERP_SITE_URL',$config['erp_site_url']);
define('BASE_DATA_PATH',BASE_ROOT_PATH.'/data');
