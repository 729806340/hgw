...
class UploadFile{
	 ...
	 * 允许上传的文件类型
	 */
	private $allow_type=array('gif','jpg','jpeg','bmp','png','swf','tbi','doc','docx','xls','xlsx','rar','zip','csv');
	/**
	 * 允许的最大文件大小，单位为KB
	 */
	private $max_size = '2024';
	/**
	 * 改变后的图片宽度
	 */
	 ...
	 * @param boolean $isImage 是否图像
	 * @return bool
	 */
	public function upfile($field,$isImage=true){
		...
		//检查是否为有效图片
		if($isImage&&!$image_info = @getimagesize($this->upload_file['tmp_name'])) {
