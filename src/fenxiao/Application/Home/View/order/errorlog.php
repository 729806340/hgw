                    ...
                    <div class="con-inside">
                        ...
                        <div class="operation clear">
                            <form method="get" action="#">
                                ...
                                <div class="search fl"><span class="fl"></span><i class="fl"></i>
                                    <input class="w100 fl" type="text" placeholder="信息过滤" id="keywords" />
                                </div>
								<div class="fl">
...
<script type="text/javascript">
    ...
    function getData(page, orderid,keywords) { //获取当前页数据
        ...
        $.ajax({
            ...
            data: {'page': page, 'action': 'loglist',  'oid': oid, 'logtype': logtype, 'keywords': keywords },
            dataType: 'json',
