    ...
    function r(r) {
        $.ajax({
            ...
            success: function (e) {
                    ...
                    $("#add-cart").click(function () {
                        ...
                        if (!e) {
                            ...
                            $.ajax({
                                ...
                                data: {key: e, goods_id: r, quantity: t},
                                type: "post",
                                success: function (e) {
                                    var t = $.parseJSON(e);
                ...
                //显示隐藏限时模块
                var w = e.datas.goods_info.promotion_type;
                console.log('w的值',w);
                if( w == "xianshi"){
                    $('.ms-title').show();
                }else {
                ...
                if(e.datas.goods_info.xianshi_info){

                //倒计时
                var start_time = e.datas.goods_info.xianshi_info.start_time;
                var end_time = e.datas.goods_info.xianshi_info.end_time;
                var now_time = e.datas.goods_info.xianshi_info.now_time;
                var new_settime;
                //var i =1;
